...
- github.com/ipfs/go-ipfs:
  - fix 3 bugs responsible for a goroutine leak (plus one other bug) ([ipfs/go-ipfs#7491](https://github.com/glvd/starship/pull/7491))
  - docs(config): update toc ([ipfs/go-ipfs#7483](https://github.com/glvd/starship/pull/7483))
  - feat: transport config ([ipfs/go-ipfs#7479](https://github.com/glvd/starship/pull/7479))
  - fix the minimal go version under 'Build from Source' ([ipfs/go-ipfs#7459](https://github.com/glvd/starship/pull/7459))
  ...
  - backport fixes ([ipfs/go-ipfs#7405](https://github.com/glvd/starship/pull/7405))
    - Use bitswap sessions for `ipfs refs`.
    - Update to webui 2.9.0
  - feat: add noise support ([ipfs/go-ipfs#7365](https://github.com/glvd/starship/pull/7365))
  - feat: implement peering service ([ipfs/go-ipfs#7362](https://github.com/glvd/starship/pull/7362))
  - Include the git blob id of the dir-index bundle in the ETag ([ipfs/go-ipfs#7360](https://github.com/glvd/starship/pull/7360))
  - feat: bootstrap in dht when the routing table is empty ([ipfs/go-ipfs#7340](https://github.com/glvd/starship/pull/7340))
  - quic: remove experimental status and add it to the default config ([ipfs/go-ipfs#7349](https://github.com/glvd/starship/pull/7349))
  - fix: support directory listings even if a 404 page is present ([ipfs/go-ipfs#7339](https://github.com/glvd/starship/pull/7339))
  - doc(plugin): document plugin config ([ipfs/go-ipfs#7309](https://github.com/glvd/starship/pull/7309))
  - test(sharness): fix fuse tests ([ipfs/go-ipfs#7320](https://github.com/glvd/starship/pull/7320))
  - docs: update experimental-features doc with IPNS over pubsub changes. ([ipfs/go-ipfs#7334](https://github.com/glvd/starship/pull/7334))
  - docs: cleanup config formatting ([ipfs/go-ipfs#7336](https://github.com/glvd/starship/pull/7336))
  - fix(gateway): ensure directory listings have Content-Type text/html ([ipfs/go-ipfs#7330](https://github.com/glvd/starship/pull/7330))
  - test(sharness): test the local symlink ([ipfs/go-ipfs#7332](https://github.com/glvd/starship/pull/7332))
  - misc config/experimental-features doc fixes ([ipfs/go-ipfs#7333](https://github.com/glvd/starship/pull/7333))
  - fix: correctly trim resolved IPNS addresses ([ipfs/go-ipfs#7331](https://github.com/glvd/starship/pull/7331))
  - Gateway renders pretty 404 pages if available ([ipfs/go-ipfs#4233](https://github.com/glvd/starship/pull/4233))
  - feat: add a dht stat command ([ipfs/go-ipfs#7221](https://github.com/glvd/starship/pull/7221))
  - fix: update dists url for OpenBSD support ([ipfs/go-ipfs#7311](https://github.com/glvd/starship/pull/7311))
  - docs: X-Forwarded-Proto: https ([ipfs/go-ipfs#7306](https://github.com/glvd/starship/pull/7306))
  - fix(mkreleaselog): make robust against running in different working directories ([ipfs/go-ipfs#7310](https://github.com/glvd/starship/pull/7310))
  - fix(mkreleasenotes): include commits directly to master ([ipfs/go-ipfs#7296](https://github.com/glvd/starship/pull/7296))
  - write api file automically ([ipfs/go-ipfs#7282](https://github.com/glvd/starship/pull/7282))
  - systemd: disable swap-usage for ipfs ([ipfs/go-ipfs#7299](https://github.com/glvd/starship/pull/7299))
  - systemd: add helptext ([ipfs/go-ipfs#7265](https://github.com/glvd/starship/pull/7265))
  - systemd: add the link to the docs ([ipfs/go-ipfs#7287](https://github.com/glvd/starship/pull/7287))
  - systemd: add state directory setting ([ipfs/go-ipfs#7288](https://github.com/glvd/starship/pull/7288))
  - Update go version required to build ([ipfs/go-ipfs#7289](https://github.com/glvd/starship/pull/7289))
  - pin: implement pin/ls with only CoreApi ([ipfs/go-ipfs#6774](https://github.com/glvd/starship/pull/6774))
  - update go-libp2p-quic-transport to v0.3.7 ([ipfs/go-ipfs#7278](https://github.com/glvd/starship/pull/7278))
  - Docs: Delete section headers for removed features ([ipfs/go-ipfs#7277](https://github.com/glvd/starship/pull/7277))
  - README.md: typo ([ipfs/go-ipfs#7061](https://github.com/glvd/starship/pull/7061))
  - PR autocomment: Only comment for first-time contributors ([ipfs/go-ipfs#7270](https://github.com/glvd/starship/pull/7270))
  - Fixed typo in config.md ([ipfs/go-ipfs#7267](https://github.com/glvd/starship/pull/7267))
  - Fixes #7252 - Uses gabriel-vasile/mimetype to support additional content types ([ipfs/go-ipfs#7262](https://github.com/glvd/starship/pull/7262))
  - update go-libp2p-quic-transport to v0.3.6 ([ipfs/go-ipfs#7266](https://github.com/glvd/starship/pull/7266))
  - Updates bash completions to be compatible with zsh ([ipfs/go-ipfs#7261](https://github.com/glvd/starship/pull/7261))
  - systemd service enhancements + run as system user ([ipfs/go-ipfs#7259](https://github.com/glvd/starship/pull/7259))
  - upgrade to go 1.14.2 ([ipfs/go-ipfs#7130](https://github.com/glvd/starship/pull/7130))
  - Add module files for go-ipfs-as-a-library example ([ipfs/go-ipfs#7146](https://github.com/glvd/starship/pull/7146))
  - feat(gateway): show the absolute path and CID every time ([ipfs/go-ipfs#7219](https://github.com/glvd/starship/pull/7219))
  - fix: do not use hard coded IPNS Publish maximum timeout duration ([ipfs/go-ipfs#7256](https://github.com/glvd/starship/pull/7256))
  - Auto-comment on submitted PRs ([ipfs/go-ipfs#7248](https://github.com/glvd/starship/pull/7248))
  - Fixes Github link. ([ipfs/go-ipfs#7239](https://github.com/glvd/starship/pull/7239))
  - docs: fix subdomain examples in CHANGELOG ([ipfs/go-ipfs#7240](https://github.com/glvd/starship/pull/7240))
  - doc: add snap to the release checklist ([ipfs/go-ipfs#7253](https://github.com/glvd/starship/pull/7253))
  - Welcome message for users opening their first issue ([ipfs/go-ipfs#7247](https://github.com/glvd/starship/pull/7247))
  - feat: bump to 0.6.0-dev ([ipfs/go-ipfs#7249](https://github.com/glvd/starship/pull/7249))
...
- github.com/ipfs/go-ipfs:
  - IPNS timeout patch from master ([ipfs/go-ipfs#7276](https://github.com/glvd/starship/pull/7276))
...
If you've ever seen [the error](https://github.com/glvd/starship/issues/5784):
...
- github.com/ipfs/go-ipfs:
  - fix: non-blocking peerlog logging ([ipfs/go-ipfs#7232](https://github.com/glvd/starship/pull/7232))
  - doc: update go-ipfs docs for 0.5.0 release ([ipfs/go-ipfs#7229](https://github.com/glvd/starship/pull/7229))
  - Add additional documentation links to the new issue screen ([ipfs/go-ipfs#7226](https://github.com/glvd/starship/pull/7226))
  - docs: note that ShardingEnabled is a global flag ([ipfs/go-ipfs#7218](https://github.com/glvd/starship/pull/7218))
  - update log helptext to match actual levels ([ipfs/go-ipfs#7199](https://github.com/glvd/starship/pull/7199))
  - Chore/harden car test a bit harder ([ipfs/go-ipfs#7209](https://github.com/glvd/starship/pull/7209))
  - fix: fix duplicate block issue in bitswap ([ipfs/go-ipfs#7202](https://github.com/glvd/starship/pull/7202))
  - feat: update docker image ([ipfs/go-ipfs#7191](https://github.com/glvd/starship/pull/7191))
  - feat: update dir index ([ipfs/go-ipfs#7192](https://github.com/glvd/starship/pull/7192))
  - fix: update the dht to fix yggdrasil ([ipfs/go-ipfs#7186](https://github.com/glvd/starship/pull/7186))
  - Choose architecture when download tini into docker container ([ipfs/go-ipfs#7187](https://github.com/glvd/starship/pull/7187))
  - Fix typos and cleanup ([ipfs/go-ipfs#7181](https://github.com/glvd/starship/pull/7181))
  - Fixtypos ([ipfs/go-ipfs#7180](https://github.com/glvd/starship/pull/7180))
  - feat: webui 2.7.5 ([ipfs/go-ipfs#7176](https://github.com/glvd/starship/pull/7176))
  - integration test for the dual dht ([ipfs/go-ipfs#7151](https://github.com/glvd/starship/pull/7151))
  - fix: subdomain redirect for dir CIDs ([ipfs/go-ipfs#7165](https://github.com/glvd/starship/pull/7165))
  - add autonat config options ([ipfs/go-ipfs#7162](https://github.com/glvd/starship/pull/7162))
  - docs: fix link to version.go ([ipfs/go-ipfs#7157](https://github.com/glvd/starship/pull/7157))
  - feat: webui v2.7.4 ([ipfs/go-ipfs#7159](https://github.com/glvd/starship/pull/7159))
  - fix the typo in the serveHTTPApi ([ipfs/go-ipfs#7156](https://github.com/glvd/starship/pull/7156))
  - test(sharness): improve CAR tests to remove some potential races ([ipfs/go-ipfs#7154](https://github.com/glvd/starship/pull/7154))
  - feat: introduce the dual WAN/LAN DHT ([ipfs/go-ipfs#7127](https://github.com/glvd/starship/pull/7127))
  - fix: invalidate cache on failed publish ([ipfs/go-ipfs#7152](https://github.com/glvd/starship/pull/7152))
  - Temporarily disable gc-race test ([ipfs/go-ipfs#7148](https://github.com/glvd/starship/pull/7148))
  - Beef up and harden import/export tests ([ipfs/go-ipfs#7140](https://github.com/glvd/starship/pull/7140))
  - Filter dials to blocked subnets, even when using DNS. ([ipfs/go-ipfs#6996](https://github.com/glvd/starship/pull/6996))
  - Dag export command, complete ([ipfs/go-ipfs#7036](https://github.com/glvd/starship/pull/7036))
  - Adding Fission to IPFS early testers page ([ipfs/go-ipfs#7119](https://github.com/glvd/starship/pull/7119))
  - feat: bump version ([ipfs/go-ipfs#7110](https://github.com/glvd/starship/pull/7110))
  - feat: initial update to the changelog for 0.5.0 ([ipfs/go-ipfs#6977](https://github.com/glvd/starship/pull/6977))
  - feat(dht): update to cypress DHT in backwards compatibility mode ([ipfs/go-ipfs#7103](https://github.com/glvd/starship/pull/7103))
  - update bash completion for `ipfs add` ([ipfs/go-ipfs#7102](https://github.com/glvd/starship/pull/7102))
  - HTTP API: Only allow POST requests (plus OPTIONS) ([ipfs/go-ipfs#7097](https://github.com/glvd/starship/pull/7097))
  - Revert last change (the default is now printed twice) ([ipfs/go-ipfs#7098](https://github.com/glvd/starship/pull/7098))
  - Fix #4996: Improve help text for "ipfs files cp" ([ipfs/go-ipfs#7069](https://github.com/glvd/starship/pull/7069))
  - changed brew to brew cask ([ipfs/go-ipfs#7072](https://github.com/glvd/starship/pull/7072))
  - fix: remove internal relay discovery ([ipfs/go-ipfs#7064](https://github.com/glvd/starship/pull/7064))
  - docs/experimental-features.md: typo ([ipfs/go-ipfs#7062](https://github.com/glvd/starship/pull/7062))
  - fix: get rid of shutdown errors ([ipfs/go-ipfs#7058](https://github.com/glvd/starship/pull/7058))
  - feat: tls by default ([ipfs/go-ipfs#7055](https://github.com/glvd/starship/pull/7055))
  - fix: downgrade to go 1.13 ([ipfs/go-ipfs#7054](https://github.com/glvd/starship/pull/7054))
  - Keystore: minor maintenance ([ipfs/go-ipfs#7043](https://github.com/glvd/starship/pull/7043))
  - fix(keystore): avoid racy filesystem access ([ipfs/go-ipfs#6999](https://github.com/glvd/starship/pull/6999))
  - Forgotten go-fmt ([ipfs/go-ipfs#7030](https://github.com/glvd/starship/pull/7030))
  - feat: update go-libp2p & go-bitswap ([ipfs/go-ipfs#7028](https://github.com/glvd/starship/pull/7028))
  - Introducing EncodedFSKeystore with base32 encoding (#5947) ([ipfs/go-ipfs#6955](https://github.com/glvd/starship/pull/6955))
  - feat: improve key lookup ([ipfs/go-ipfs#7023](https://github.com/glvd/starship/pull/7023))
  - feat(file-ignore): add ignore opts to add cmd ([ipfs/go-ipfs#7017](https://github.com/glvd/starship/pull/7017))
  - feat: gateway subdomains + http proxy mode ([ipfs/go-ipfs#6096](https://github.com/glvd/starship/pull/6096))
  - Chore/sharness fixes 2019 03 16 ([ipfs/go-ipfs#6997](https://github.com/glvd/starship/pull/6997))
  - Support pipes when named on the cli explicitly ([ipfs/go-ipfs#6998](https://github.com/glvd/starship/pull/6998))
  - Fix a typo ([ipfs/go-ipfs#7000](https://github.com/glvd/starship/pull/7000))
  - fix: revert changes to the user agent ([ipfs/go-ipfs#6993](https://github.com/glvd/starship/pull/6993))
  - feat(peerlog): log protocols/versions ([ipfs/go-ipfs#6972](https://github.com/glvd/starship/pull/6972))
  - feat: docker build and tag from ci ([ipfs/go-ipfs#6949](https://github.com/glvd/starship/pull/6949))
  - cmd: ipfs handle GUI environment on Windows ([ipfs/go-ipfs#6646](https://github.com/glvd/starship/pull/6646))
  - Chore/macos sharness fixes ([ipfs/go-ipfs#6988](https://github.com/glvd/starship/pull/6988))
  - Update to go-libp2p 0.6.0 ([ipfs/go-ipfs#6914](https://github.com/glvd/starship/pull/6914))
  - mount: switch over to the CoreAPI ([ipfs/go-ipfs#6602](https://github.com/glvd/starship/pull/6602))
  - doc(commands): document that `dht put` takes a file ([ipfs/go-ipfs#6960](https://github.com/glvd/starship/pull/6960))
  - docs: update licence info in README ([ipfs/go-ipfs#6942](https://github.com/glvd/starship/pull/6942))
  - docs: fix example for files.write ([ipfs/go-ipfs#6943](https://github.com/glvd/starship/pull/6943))
  - feat(graphsync): mount the graphsync libp2p protocol ([ipfs/go-ipfs#6892](https://github.com/glvd/starship/pull/6892))
  - feat: update go in docker container ([ipfs/go-ipfs#6933](https://github.com/glvd/starship/pull/6933))
  - remove expired GPG key from README ([ipfs/go-ipfs#6931](https://github.com/glvd/starship/pull/6931))
  - test(sharness): test our tests ([ipfs/go-ipfs#6908](https://github.com/glvd/starship/pull/6908))
  - fix: broken interop tests ([ipfs/go-ipfs#6899](https://github.com/glvd/starship/pull/6899))
  - feat: pass IPFS_PLUGINS to docker build ([ipfs/go-ipfs#6898](https://github.com/glvd/starship/pull/6898))
  - doc(add): document hash stability ([ipfs/go-ipfs#6891](https://github.com/glvd/starship/pull/6891))
  - feat: add peerlog plugin ([ipfs/go-ipfs#6887](https://github.com/glvd/starship/pull/6887))
  - doc(plugin): document internal plugins ([ipfs/go-ipfs#6888](https://github.com/glvd/starship/pull/6888))
  - Fix #6878: Improve MFS Cli documentation  ([ipfs/go-ipfs#6882](https://github.com/glvd/starship/pull/6882))
  - Update the license distributed with dist builds to the dual one ([ipfs/go-ipfs#6879](https://github.com/glvd/starship/pull/6879))
  - doc: add license URLs so go's doc service can detect our license ([ipfs/go-ipfs#6874](https://github.com/glvd/starship/pull/6874))
  - doc: rename COPYRIGHT to LICENSE ([ipfs/go-ipfs#6873](https://github.com/glvd/starship/pull/6873))
  - fix: fix id addr format ([ipfs/go-ipfs#6872](https://github.com/glvd/starship/pull/6872))
  - Help text update for 'ipfs key gen' ([ipfs/go-ipfs#6867](https://github.com/glvd/starship/pull/6867))
  - fix: make rsa the default key type ([ipfs/go-ipfs#6864](https://github.com/glvd/starship/pull/6864))
  - doc(config): cleanup ([ipfs/go-ipfs#6855](https://github.com/glvd/starship/pull/6855))
  - Allow building non-amd64 Docker images ([ipfs/go-ipfs#6854](https://github.com/glvd/starship/pull/6854))
  - doc(release): add Charity Engine to the early testers programme ([ipfs/go-ipfs#6850](https://github.com/glvd/starship/pull/6850))
  - fix: fix a potential out of bounds issue in fuse ([ipfs/go-ipfs#6847](https://github.com/glvd/starship/pull/6847))
  - fix(build): instruct users to use GOTAGS, not GOFLAGS ([ipfs/go-ipfs#6843](https://github.com/glvd/starship/pull/6843))
  - doc(release): document how RCs should be communicated ([ipfs/go-ipfs#6845](https://github.com/glvd/starship/pull/6845))
  - doc(release): move WebUI from manual tests to automated tests section ([ipfs/go-ipfs#6838](https://github.com/glvd/starship/pull/6838))
  - test(sharness): fix typo ([ipfs/go-ipfs#6835](https://github.com/glvd/starship/pull/6835))
  - test: E2E tests against ipfs-webui HEAD ([ipfs/go-ipfs#6825](https://github.com/glvd/starship/pull/6825))
  - mkreleaslog: improve edge-cases ([ipfs/go-ipfs#6833](https://github.com/glvd/starship/pull/6833))
  - fix: dont fail to collect profiles if no ipfs bin ([ipfs/go-ipfs#6829](https://github.com/glvd/starship/pull/6829))
  - update dockerfile and use openssl ([ipfs/go-ipfs#6828](https://github.com/glvd/starship/pull/6828))
  - docs: define Gateway.PathPrefixes ([ipfs/go-ipfs#6826](https://github.com/glvd/starship/pull/6826))
  - fix(badgerds): turn off sync writes by default ([ipfs/go-ipfs#6819](https://github.com/glvd/starship/pull/6819))
  - gateway cleanups ([ipfs/go-ipfs#6820](https://github.com/glvd/starship/pull/6820))
  - make it possible to change the codec with the `ipfs cid` subcommand ([ipfs/go-ipfs#6817](https://github.com/glvd/starship/pull/6817))
  - improve gateway symlink handling ([ipfs/go-ipfs#6680](https://github.com/glvd/starship/pull/6680))
  - Inclusion of the presence of the go-ipfs package in Solus ([ipfs/go-ipfs#6809](https://github.com/glvd/starship/pull/6809))
  - Fix Typos ([ipfs/go-ipfs#6807](https://github.com/glvd/starship/pull/6807))
  - Sharness macos no brainer fixes ([ipfs/go-ipfs#6805](https://github.com/glvd/starship/pull/6805))
  - Support Asynchronous Datastores ([ipfs/go-ipfs#6785](https://github.com/glvd/starship/pull/6785))
  - update documentation for /ipfs -> /p2p multiaddr switch ([ipfs/go-ipfs#6538](https://github.com/glvd/starship/pull/6538))
  - IPNS over PubSub as an Independent Transport ([ipfs/go-ipfs#6758](https://github.com/glvd/starship/pull/6758))
  - docs: add information on how to enable experiments ([ipfs/go-ipfs#6792](https://github.com/glvd/starship/pull/6792))
  - Change Reporter to BandwidthCounter in IpfsNode ([ipfs/go-ipfs#6793](https://github.com/glvd/starship/pull/6793))
  - update go-datastore ([ipfs/go-ipfs#6791](https://github.com/glvd/starship/pull/6791))
  - go fmt: go-ipfs-as-a-library ([ipfs/go-ipfs#6784](https://github.com/glvd/starship/pull/6784))
  - feat: web ui 2.7.2 ([ipfs/go-ipfs#6778](https://github.com/glvd/starship/pull/6778))
  - extract the pinner to go-ipfs-pinner and dagutils into go-merkledag ([ipfs/go-ipfs#6771](https://github.com/glvd/starship/pull/6771))
  - fix #2203: omit the charset attribute when Content-Type is text/html ([ipfs/go-ipfs#6743](https://github.com/glvd/starship/pull/6743))
  - Pin ls traverses all indirect pins ([ipfs/go-ipfs#6705](https://github.com/glvd/starship/pull/6705))
  - fix: ignore nonexistant when force rm ([ipfs/go-ipfs#6773](https://github.com/glvd/starship/pull/6773))
  - introduce IpfsNode Plugin ([ipfs/go-ipfs#6719](https://github.com/glvd/starship/pull/6719))
  - improve documentation and fix dht put bug ([ipfs/go-ipfs#6750](https://github.com/glvd/starship/pull/6750))
  - Adding alias for `ipfs repo stat`. ([ipfs/go-ipfs#6769](https://github.com/glvd/starship/pull/6769))
  - doc(gateway): document dnslink ([ipfs/go-ipfs#6767](https://github.com/glvd/starship/pull/6767))
  - pin: add context and error return to most of the Pinner functions ([ipfs/go-ipfs#6715](https://github.com/glvd/starship/pull/6715))
  - feat: web ui 2.7.1 ([ipfs/go-ipfs#6762](https://github.com/glvd/starship/pull/6762))
  - doc(README): document requirements for cross-compiling with OpenSSL support ([ipfs/go-ipfs#6738](https://github.com/glvd/starship/pull/6738))
  - feat: web ui 2.6.0 ([ipfs/go-ipfs#6740](https://github.com/glvd/starship/pull/6740))
  - Add high-level go-ipfs architecture diagram ([ipfs/go-ipfs#6727](https://github.com/glvd/starship/pull/6727))
  - docs: remove extra ) on the example README ([ipfs/go-ipfs#6733](https://github.com/glvd/starship/pull/6733))
  - update maintainer label ([ipfs/go-ipfs#6735](https://github.com/glvd/starship/pull/6735))
  - ipfs namespace is now being provided to prometheus ([ipfs/go-ipfs#6643](https://github.com/glvd/starship/pull/6643))
  - feat: web ui 2.5.8 ([ipfs/go-ipfs#6718](https://github.com/glvd/starship/pull/6718))
  - docs: add connmgr to config.md toc ([ipfs/go-ipfs#6712](https://github.com/glvd/starship/pull/6712))
  - feat: web ui 2.5.7 ([ipfs/go-ipfs#6707](https://github.com/glvd/starship/pull/6707))
  - README: improve build documentation ([ipfs/go-ipfs#6706](https://github.com/glvd/starship/pull/6706))
  - Introduce buzhash chunker       ([ipfs/go-ipfs#6701](https://github.com/glvd/starship/pull/6701))
  - Pinning interop: Pin ls returns appropriate zero value ([ipfs/go-ipfs#6685](https://github.com/glvd/starship/pull/6685))
  - fix(resolve): correctly handle .eth domains ([ipfs/go-ipfs#6700](https://github.com/glvd/starship/pull/6700))
  - Update README.md ([ipfs/go-ipfs#6697](https://github.com/glvd/starship/pull/6697))
  - daemon: support unix domain sockets for the API/gateway ([ipfs/go-ipfs#6678](https://github.com/glvd/starship/pull/6678))
  - docs: guide users to the right locations for questions ([ipfs/go-ipfs#6691](https://github.com/glvd/starship/pull/6691))
  - docs: readme improvements ([ipfs/go-ipfs#6693](https://github.com/glvd/starship/pull/6693))
  - docs: link remaining docs available, guide people to the right locations ([ipfs/go-ipfs#6694](https://github.com/glvd/starship/pull/6694))
  - docs: fix broken url ([ipfs/go-ipfs#6692](https://github.com/glvd/starship/pull/6692))
  - add systemd support ([ipfs/go-ipfs#6675](https://github.com/glvd/starship/pull/6675))
  - feat: add ipfs version info to prometheus metrics ([ipfs/go-ipfs#6688](https://github.com/glvd/starship/pull/6688))
  - Fix typo ([ipfs/go-ipfs#6686](https://github.com/glvd/starship/pull/6686))
  - github: migrate actions ([ipfs/go-ipfs#6681](https://github.com/glvd/starship/pull/6681))
  - Add bridged chats ([ipfs/go-ipfs#6653](https://github.com/glvd/starship/pull/6653))
  - doc(config): improve DisableNatPortMap documentation ([ipfs/go-ipfs#6655](https://github.com/glvd/starship/pull/6655))
  - plugins: support Close() for Tracer plugins as well ([ipfs/go-ipfs#6672](https://github.com/glvd/starship/pull/6672))
  - fix: make collect-profiles.sh work on mac ([ipfs/go-ipfs#6673](https://github.com/glvd/starship/pull/6673))
  - namesys(test): test TTL on publish ([ipfs/go-ipfs#6671](https://github.com/glvd/starship/pull/6671))
  - discovery: improve mdns warnings ([ipfs/go-ipfs#6665](https://github.com/glvd/starship/pull/6665))
  - feat: web ui 2.5.4 ([ipfs/go-ipfs#6664](https://github.com/glvd/starship/pull/6664))
  - cmds(help): fix swarm filter add/rm help text ([ipfs/go-ipfs#6654](https://github.com/glvd/starship/pull/6654))
  - feat: webui 2.5.3 ([ipfs/go-ipfs#6638](https://github.com/glvd/starship/pull/6638))
  - feat: web ui 2.5.1 ([ipfs/go-ipfs#6630](https://github.com/glvd/starship/pull/6630))
  - docs: add multiple gateway and api addrs ([ipfs/go-ipfs#6631](https://github.com/glvd/starship/pull/6631))
  - doc: add post-release checklist ([ipfs/go-ipfs#6625](https://github.com/glvd/starship/pull/6625))
  - docs: add ship date and next release issue opening time ([ipfs/go-ipfs#6620](https://github.com/glvd/starship/pull/6620))
  - docker: libdl dependency ([ipfs/go-ipfs#6624](https://github.com/glvd/starship/pull/6624))
  - docs: improvements to the release doc ([ipfs/go-ipfs#6616](https://github.com/glvd/starship/pull/6616))
  - plugins: add support for plugin configs ([ipfs/go-ipfs#6613](https://github.com/glvd/starship/pull/6613))
  - Update README.md ([ipfs/go-ipfs#6615](https://github.com/glvd/starship/pull/6615))
  - doc: remove gmake instructions ([ipfs/go-ipfs#6614](https://github.com/glvd/starship/pull/6614))
  - feat: add ability to use existing config during init ([ipfs/go-ipfs#6489](https://github.com/glvd/starship/pull/6489))
  - doc: expand and cleanup badger documentation ([ipfs/go-ipfs#6611](https://github.com/glvd/starship/pull/6611))
  - feat: improve plugin preload logic ([ipfs/go-ipfs#6576](https://github.com/glvd/starship/pull/6576))
  - version: don't print 'VERSION-' if no commit is specified ([ipfs/go-ipfs#6609](https://github.com/glvd/starship/pull/6609))
  - Update go-libp2p, fix tests with weak RSA keys ([ipfs/go-ipfs#6555](https://github.com/glvd/starship/pull/6555))
  - cmds/refs: fix ipfs refs for sharded directories ([ipfs/go-ipfs#6601](https://github.com/glvd/starship/pull/6601))
  - fix: spammy mock when testing ([ipfs/go-ipfs#6583](https://github.com/glvd/starship/pull/6583))
  - docker: update the docker image ([ipfs/go-ipfs#6582](https://github.com/glvd/starship/pull/6582))
  - add release process graphic ([ipfs/go-ipfs#6568](https://github.com/glvd/starship/pull/6568))
  - feat: web ui 2.5.0 ([ipfs/go-ipfs#6566](https://github.com/glvd/starship/pull/6566))
  - Add swarm key variables to container daemon ([ipfs/go-ipfs#6554](https://github.com/glvd/starship/pull/6554))
  - doc: update the release template ([ipfs/go-ipfs#6561](https://github.com/glvd/starship/pull/6561))
  - merge changelog and bump version ([ipfs/go-ipfs#6559](https://github.com/glvd/starship/pull/6559))
  - require GNU make ([ipfs/go-ipfs#6551](https://github.com/glvd/starship/pull/6551))
  - tweak the release process ([ipfs/go-ipfs#6553](https://github.com/glvd/starship/pull/6553))
  - Allow resolution of .eth names via .eth.link ([ipfs/go-ipfs#6448](https://github.com/glvd/starship/pull/6448))
  - README: update minimum system requirements and recommend OpenSSL ([ipfs/go-ipfs#6543](https://github.com/glvd/starship/pull/6543))
  - fix and improve the writable gateway ([ipfs/go-ipfs#6539](https://github.com/glvd/starship/pull/6539))
  - feat: add install instructions for external commands ([ipfs/go-ipfs#6541](https://github.com/glvd/starship/pull/6541))
  - fix: slightly faster gc ([ipfs/go-ipfs#6505](https://github.com/glvd/starship/pull/6505))
  - fix {net,open}bsd build by disabling fuse on openbsd ([ipfs/go-ipfs#6535](https://github.com/glvd/starship/pull/6535))
  - mk: handle stripping paths when GOPATH contains whitespace ([ipfs/go-ipfs#6536](https://github.com/glvd/starship/pull/6536))
  - make gossipsub the default routing protocol for pubsub ([ipfs/go-ipfs#6512](https://github.com/glvd/starship/pull/6512))
  - doc: align the early testers program description with its goal ([ipfs/go-ipfs#6529](https://github.com/glvd/starship/pull/6529))
  - feat: add --long as alias for -l in files.ls ([ipfs/go-ipfs#6528](https://github.com/glvd/starship/pull/6528))
  - switch to new merkledag walk functions ([ipfs/go-ipfs#6499](https://github.com/glvd/starship/pull/6499))
  - readme: fix CI badge ([ipfs/go-ipfs#6521](https://github.com/glvd/starship/pull/6521))
  - Adds Siderus in early testers ([ipfs/go-ipfs#6517](https://github.com/glvd/starship/pull/6517))
  - Extract Filestore ([ipfs/go-ipfs#6511](https://github.com/glvd/starship/pull/6511))
  - readme: fix scoop bucket command error ([ipfs/go-ipfs#6510](https://github.com/glvd/starship/pull/6510))
  - sharness: test pin ls stream ([ipfs/go-ipfs#6504](https://github.com/glvd/starship/pull/6504))
  - Improve pin/update description ([ipfs/go-ipfs#6501](https://github.com/glvd/starship/pull/6501))
  - pin cmd: stream recursive pins ([ipfs/go-ipfs#6493](https://github.com/glvd/starship/pull/6493))
  - Document the AddrFilters option ([ipfs/go-ipfs#6459](https://github.com/glvd/starship/pull/6459))
  - feat: make it easier to load custom plugins ([ipfs/go-ipfs#6474](https://github.com/glvd/starship/pull/6474))
  - document the debug script ([ipfs/go-ipfs#6486](https://github.com/glvd/starship/pull/6486))
  - Extract provider module to `go-ipfs-provider` ([ipfs/go-ipfs#6421](https://github.com/glvd/starship/pull/6421))
  - ignore stale API files and deprecate ipfs repo fsck ([ipfs/go-ipfs#6478](https://github.com/glvd/starship/pull/6478))
  - Fix node construction queue error ([ipfs/go-ipfs#6480](https://github.com/glvd/starship/pull/6480))
  - Update the required go version in the README ([ipfs/go-ipfs#6462](https://github.com/glvd/starship/pull/6462))
  - gitmodules: use https so we don't need an ssh key ([ipfs/go-ipfs#6450](https://github.com/glvd/starship/pull/6450))
  - doc: add another Windows package to README ([ipfs/go-ipfs#6440](https://github.com/glvd/starship/pull/6440))
  - Close started plugins when one of them fails to start. ([ipfs/go-ipfs#6438](https://github.com/glvd/starship/pull/6438))
  - Load plugins on darwin/macOS ([ipfs/go-ipfs#6439](https://github.com/glvd/starship/pull/6439))
  - assets: move away from gx ([ipfs/go-ipfs#6414](https://github.com/glvd/starship/pull/6414))
  - Fix a typo ([ipfs/go-ipfs#6432](https://github.com/glvd/starship/pull/6432))
  - docs: fix install guide link ([ipfs/go-ipfs#6423](https://github.com/glvd/starship/pull/6423))
  - Deps: update go-libp2p-http to its new libp2p location ([ipfs/go-ipfs#6422](https://github.com/glvd/starship/pull/6422))
  - install.sh: Fix wrong destination path for ipfs binary ([ipfs/go-ipfs#6424](https://github.com/glvd/starship/pull/6424))
  - build: strip GOPATH from build paths ([ipfs/go-ipfs#6412](https://github.com/glvd/starship/pull/6412))
  - libp2p: moves discovery after host listen ([ipfs/go-ipfs#6415](https://github.com/glvd/starship/pull/6415))
  - remove mentions of gx from windows build docs ([ipfs/go-ipfs#6413](https://github.com/glvd/starship/pull/6413))
  - build: use protoc-gen-* from gomod ([ipfs/go-ipfs#6411](https://github.com/glvd/starship/pull/6411))
  - add unixfs get metric ([ipfs/go-ipfs#6406](https://github.com/glvd/starship/pull/6406))
  - Run JS interop in CircleCI ([ipfs/go-ipfs#6409](https://github.com/glvd/starship/pull/6409))
  - Usage of context helper in Blockstore provider ([ipfs/go-ipfs#6399](https://github.com/glvd/starship/pull/6399))
  - docs: default value for HashOnRead is false ([ipfs/go-ipfs#6401](https://github.com/glvd/starship/pull/6401))
  - block cmd: allow adding multiple blocks at once ([ipfs/go-ipfs#6331](https://github.com/glvd/starship/pull/6331))
  - Remove Repo from routing fx provider parameter ([ipfs/go-ipfs#6395](https://github.com/glvd/starship/pull/6395))
  - migrate to go-libp2p-core. ([ipfs/go-ipfs#6384](https://github.com/glvd/starship/pull/6384))
  - feat: update Web UI to v2.4.6 ([ipfs/go-ipfs#6392](https://github.com/glvd/starship/pull/6392))
  - Introduce first strategic provider: do nothing ([ipfs/go-ipfs#6292](https://github.com/glvd/starship/pull/6292))
...
- github.com/ipfs/go-ipfs:
  - feat: update the webui to fix some performance issues ([ipfs/go-ipfs#6844](https://github.com/glvd/starship/pull/6844))
  - fix: limit SW registration to content root ([ipfs/go-ipfs#6801](https://github.com/glvd/starship/pull/6801))
  - fix issue 6760, adding with hash-only, high CPU usage. ([ipfs/go-ipfs#6764](https://github.com/glvd/starship/pull/6764))
  - fix(coreapi/add): close the fake repo used when adding with hash-only ([ipfs/go-ipfs#6747](https://github.com/glvd/starship/pull/6747))
  - fix bug 6748 ([ipfs/go-ipfs#6754](https://github.com/glvd/starship/pull/6754))
  - fix(pin): wait till after fetching to remove direct pin ([ipfs/go-ipfs#6708](https://github.com/glvd/starship/pull/6708))
  - pin: fix pin update X Y where X==Y ([ipfs/go-ipfs#6669](https://github.com/glvd/starship/pull/6669))
  - namesys: set the correct cache TTL on publish ([ipfs/go-ipfs#6667](https://github.com/glvd/starship/pull/6667))
  - build: fix golangci again ([ipfs/go-ipfs#6641](https://github.com/glvd/starship/pull/6641))
  - make: move all test deps to a separate module ([ipfs/go-ipfs#6637](https://github.com/glvd/starship/pull/6637))
  - fix: close peerstore on stop ([ipfs/go-ipfs#6629](https://github.com/glvd/starship/pull/6629))
  - build: fix build when we don't have a full git tree ([ipfs/go-ipfs#6626](https://github.com/glvd/starship/pull/6626))
...
[release process](https://github.com/glvd/starship/blob/master/docs/releases.md)
(which we've trialed in this release) and [testing
procedures](https://github.com/glvd/starship/issues/6483).

This release includes fixes for the following regressions:

1. A major bitswap throughput regression introduced in 0.4.21
   ([ipfs/go-ipfs#6442](https://github.com/glvd/starship/issues/6442)).
...
2. The local network discovery service sometimes initializes before the
   ...
   ([ipfs/go-ipfs#6415](https://github.com/glvd/starship/pull/6415)).
   
It also includes fixes for:

1. Pins not being persisted after `ipfs block add --pin`
   ([ipfs/go-ipfs#6441](https://github.com/glvd/starship/pull/6441)).
2. Panic due to concurrent map access when adding and listing pins at the same
   time ([ipfs/go-ipfs#6419](https://github.com/glvd/starship/pull/6419)).
3. Potential pin-set corruption given a concurrent `ipfs repo gc` and `ipfs pin
   rm` ([ipfs/go-ipfs#6444](https://github.com/glvd/starship/pull/6444)).
...
* Too many open file descriptors/too many peers
  ([#6237](https://github.com/glvd/starship/issues/6237)).
* Adding multiple files at the same time doesn't work
  ([#6254](https://github.com/glvd/starship/pull/6255)).
* CPU utilization spikes and then holds at 100%
  ([#5613](https://github.com/glvd/starship/issues/5613)).
...
[#6271](https://github.com/glvd/starship/issues/6271). [It no longer does
...
browsers (see [#4143](https://github.com/glvd/starship/issues/4143).
...
2. It no longer succeeds with zero successful pings if we have a zombie but
   ...
   ([#6298](https://github.com/glvd/starship/issues/6298)).
...
- github.com/ipfs/go-ipfs:
  - fix: use http.Error for sending errors ([ipfs/go-ipfs#6379](https://github.com/glvd/starship/pull/6379))
  - core: call app.Stop once ([ipfs/go-ipfs#6380](https://github.com/glvd/starship/pull/6380))
  - explain what dhtclient does ([ipfs/go-ipfs#6375](https://github.com/glvd/starship/pull/6375))
  - ci: actually enable golangci-lint ([ipfs/go-ipfs#6362](https://github.com/glvd/starship/pull/6362))
  - commands/swarm(fix): handle empty multiaddrs ([ipfs/go-ipfs#6355](https://github.com/glvd/starship/pull/6355))
  - feat: improve errors when a path fails to parse ([ipfs/go-ipfs#6346](https://github.com/glvd/starship/pull/6346))
  - fix vendoring dependencies when building the source tarball ([ipfs/go-ipfs#6349](https://github.com/glvd/starship/pull/6349))
  - core: Use correct default for connmgr lowWater ([ipfs/go-ipfs#6352](https://github.com/glvd/starship/pull/6352))
  - doc: remove out of date documentation ([ipfs/go-ipfs#6345](https://github.com/glvd/starship/pull/6345))
  - Add generation of dependency changes to mkreleaselog ([ipfs/go-ipfs#6348](https://github.com/glvd/starship/pull/6348))
  - readme: remove mention of DCO ([ipfs/go-ipfs#6344](https://github.com/glvd/starship/pull/6344))
  - Add golangci-lint ([ipfs/go-ipfs#6321](https://github.com/glvd/starship/pull/6321))
  - docs+mk: update guidance for unsupported platforms ([ipfs/go-ipfs#6338](https://github.com/glvd/starship/pull/6338))
  - fix formatting in object get ([ipfs/go-ipfs#6340](https://github.com/glvd/starship/pull/6340))
  - fail start when loading a plugin fails ([ipfs/go-ipfs#6339](https://github.com/glvd/starship/pull/6339))
  - fix a typo in the issue template ([ipfs/go-ipfs#6335](https://github.com/glvd/starship/pull/6335))
  - github: turn issue template into a multiple-choice question ([ipfs/go-ipfs#6333](https://github.com/glvd/starship/pull/6333))
  - object put: Allow empty objects ([ipfs/go-ipfs#6330](https://github.com/glvd/starship/pull/6330))
  - Update fuse.md ([ipfs/go-ipfs#6332](https://github.com/glvd/starship/pull/6332))
  - work towards fixing dht commands ([ipfs/go-ipfs#6277](https://github.com/glvd/starship/pull/6277))
  - fix setting ulimit ([ipfs/go-ipfs#6319](https://github.com/glvd/starship/pull/6319))
  - switch to base32 by default for CIDv1 ([ipfs/go-ipfs#6300](https://github.com/glvd/starship/pull/6300))
  - cmdkit -> cmds ([ipfs/go-ipfs#6318](https://github.com/glvd/starship/pull/6318))
  - raise default fd limit to 8192 ([ipfs/go-ipfs#6266](https://github.com/glvd/starship/pull/6266))
  - pin: don't walk all pinned blocks when removing a non-existent pin ([ipfs/go-ipfs#6311](https://github.com/glvd/starship/pull/6311))
  - ping: fix a bunch of issues ([ipfs/go-ipfs#6312](https://github.com/glvd/starship/pull/6312))
  - test(coreapi): use a thread-safe datastore everywhere ([ipfs/go-ipfs#6222](https://github.com/glvd/starship/pull/6222))
  - fix(Dockerfile): Allow ipfs mount in Docker container ([ipfs/go-ipfs#5560](https://github.com/glvd/starship/pull/5560))
  - docs: fix Routing section ([ipfs/go-ipfs#6309](https://github.com/glvd/starship/pull/6309))
  - License update to dual MIT and Apache 2 ([ipfs/go-ipfs#6301](https://github.com/glvd/starship/pull/6301))
  - Go test fix ([ipfs/go-ipfs#6293](https://github.com/glvd/starship/pull/6293))
  - commands(pin update): return resolved CIDs instead of paths ([ipfs/go-ipfs#6275](https://github.com/glvd/starship/pull/6275))
  - core: fix autonat construction ([ipfs/go-ipfs#6289](https://github.com/glvd/starship/pull/6289))
  - Test and fix GC/pin bug ([ipfs/go-ipfs#6288](https://github.com/glvd/starship/pull/6288))
  - GOCC implementation & fix in make & build scripts ([ipfs/go-ipfs#6282](https://github.com/glvd/starship/pull/6282))
  - gc: cancel context ([ipfs/go-ipfs#6281](https://github.com/glvd/starship/pull/6281))
  - fix: windows friendly daemon help ([ipfs/go-ipfs#6278](https://github.com/glvd/starship/pull/6278))
  - Invert constructor config handling  ([ipfs/go-ipfs#6276](https://github.com/glvd/starship/pull/6276))
  - docs: document environment variables ([ipfs/go-ipfs#6268](https://github.com/glvd/starship/pull/6268))
  - add: Return error from iterator ([ipfs/go-ipfs#6272](https://github.com/glvd/starship/pull/6272))
  - commands(feat): use the coreapi in the urlstore command ([ipfs/go-ipfs#6259](https://github.com/glvd/starship/pull/6259))
  - humanize for ipfs bitswap stat ([ipfs/go-ipfs#6258](https://github.com/glvd/starship/pull/6258))
  - Revert "raise default fd limit to 8192" ([ipfs/go-ipfs#6265](https://github.com/glvd/starship/pull/6265))
  - raise default fd limit to 8192 ([ipfs/go-ipfs#6261](https://github.com/glvd/starship/pull/6261))
  - Fix AutoNAT service for private network ([ipfs/go-ipfs#6251](https://github.com/glvd/starship/pull/6251))
  - add: Fix adding multiple files ([ipfs/go-ipfs#6255](https://github.com/glvd/starship/pull/6255))
  - reprovider: Use goprocess ([ipfs/go-ipfs#6248](https://github.com/glvd/starship/pull/6248))
  - core/corehttp/gateway_handler: pass a request ctx instead of the node ([ipfs/go-ipfs#6244](https://github.com/glvd/starship/pull/6244))
  - constructor: cleanup some things ([ipfs/go-ipfs#6246](https://github.com/glvd/starship/pull/6246))
  - Support --human flag in cmd/object-stat ([ipfs/go-ipfs#6241](https://github.com/glvd/starship/pull/6241))
  - build: fix macos build with fuse ([ipfs/go-ipfs#6235](https://github.com/glvd/starship/pull/6235))
  - add an experiment to prefer TLS 1.3 over secio ([ipfs/go-ipfs#6229](https://github.com/glvd/starship/pull/6229))
  - fix two small nits in the go-ipfs constructor ([ipfs/go-ipfs#6234](https://github.com/glvd/starship/pull/6234))
  - DI-based core.NewNode ([ipfs/go-ipfs#6162](https://github.com/glvd/starship/pull/6162))
  - coreapi: Drop error from ParsePath ([ipfs/go-ipfs#6122](https://github.com/glvd/starship/pull/6122))
  - fix the wrong path configuration in root redirection ([ipfs/go-ipfs#6215](https://github.com/glvd/starship/pull/6215))
...
level. You can read [#5850](https://github.com/glvd/starship/issues/5850) for
...
This release also [reverts](https://github.com/glvd/starship/pull/6040) a change that
...
routers](https://github.com/glvd/starship/issues/3320).
...
You can track this issue here: https://github.com/glvd/starship/issues/5183.
...
- github.com/ipfs/go-ipfs:
  - gitattributes: avoid normalizing known binary files ([ipfs/go-ipfs#6209](https://github.com/glvd/starship/pull/6209))
  - gitattributes: default to LF ([ipfs/go-ipfs#6198](https://github.com/glvd/starship/pull/6198))
  - Fix level db panic ([ipfs/go-ipfs#6186](https://github.com/glvd/starship/pull/6186))
  - Dockerfile: Remove 2 year old deprecation warning ([ipfs/go-ipfs#6188](https://github.com/glvd/starship/pull/6188))
  - align output for the command ipfs object stat ([ipfs/go-ipfs#6189](https://github.com/glvd/starship/pull/6189))
  - provider queue: don't repeatedly retry the same item if we fail ([ipfs/go-ipfs#6187](https://github.com/glvd/starship/pull/6187))
  - test: remove version/deps from ro commands test ([ipfs/go-ipfs#6185](https://github.com/glvd/starship/pull/6185))
  - feat: add version deps command [modversion] ([ipfs/go-ipfs#6115](https://github.com/glvd/starship/pull/6115))
  - readme: update for go modules ([ipfs/go-ipfs#6180](https://github.com/glvd/starship/pull/6180))
  - Switch to Go 1.12 ([ipfs/go-ipfs#6144](https://github.com/glvd/starship/pull/6144))
  - ci: avoid interleaving output from different sharness tests ([ipfs/go-ipfs#6175](https://github.com/glvd/starship/pull/6175))
  - fix two bugs where the repo may not properly be closed ([ipfs/go-ipfs#6176](https://github.com/glvd/starship/pull/6176))
  - fix error check in swarm connect ([ipfs/go-ipfs#6174](https://github.com/glvd/starship/pull/6174))
  - feat(coreapi): tag all explicit connect requests in the connection manager ([ipfs/go-ipfs#6171](https://github.com/glvd/starship/pull/6171))
  - chore: remove CODEOWNERS ([ipfs/go-ipfs#6172](https://github.com/glvd/starship/pull/6172))
  - feat: update to IPFS Web UI 2.4.4 ([ipfs/go-ipfs#6169](https://github.com/glvd/starship/pull/6169))
  - fix add error handling ([ipfs/go-ipfs#6156](https://github.com/glvd/starship/pull/6156))
  - chore: remove waffle ([ipfs/go-ipfs#6157](https://github.com/glvd/starship/pull/6157))
  - chore: fix a bunch of issues caught by golangci-lint ([ipfs/go-ipfs#6140](https://github.com/glvd/starship/pull/6140))
  - docs/experimental-features.md: link to ipfs-ds-convert ([ipfs/go-ipfs#6154](https://github.com/glvd/starship/pull/6154))
  - interrupt: fix send on closed ([ipfs/go-ipfs#6147](https://github.com/glvd/starship/pull/6147))
  - docs: document Gateway.Writable not Gateway.Writeable ([ipfs/go-ipfs#6151](https://github.com/glvd/starship/pull/6151))
  - Fuse fixes ([ipfs/go-ipfs#6135](https://github.com/glvd/starship/pull/6135))
  - Remove duplicate blockstore from the package list ([ipfs/go-ipfs#6138](https://github.com/glvd/starship/pull/6138))
  - Query for provider head/tail ([ipfs/go-ipfs#6125](https://github.com/glvd/starship/pull/6125))
  - Remove dead link from ISSUE_TEMPLATE.md ([ipfs/go-ipfs#6128](https://github.com/glvd/starship/pull/6128))
  - coreapi: remove Unixfs.Wrap ([ipfs/go-ipfs#6123](https://github.com/glvd/starship/pull/6123))
  - coreapi unixfs: change Wrap logic to make more sense  ([ipfs/go-ipfs#6019](https://github.com/glvd/starship/pull/6019))
  - deps: switch back to jbenet go-is-domain ([ipfs/go-ipfs#6119](https://github.com/glvd/starship/pull/6119))
  - command repo stat: add human flag tests to t0080-repo.sh ([ipfs/go-ipfs#6116](https://github.com/glvd/starship/pull/6116))
  - gc: fix a potential deadlock ([ipfs/go-ipfs#6112](https://github.com/glvd/starship/pull/6112))
  - fix config options in osxfuse error messages ([ipfs/go-ipfs#6105](https://github.com/glvd/starship/pull/6105))
  - Command repo stat: improve human flag behavior ([ipfs/go-ipfs#6106](https://github.com/glvd/starship/pull/6106))
  - Provide root node immediately on add and pin add ([ipfs/go-ipfs#6068](https://github.com/glvd/starship/pull/6068))
  - gomod: Update Dockerfile, remove Dockerfile.fast ([ipfs/go-ipfs#6100](https://github.com/glvd/starship/pull/6100))
  - Return CID from 'ipfs files flush'  ([ipfs/go-ipfs#6102](https://github.com/glvd/starship/pull/6102))
  - resolve: fix recursion ([ipfs/go-ipfs#6087](https://github.com/glvd/starship/pull/6087))
  - fix(swarm): add dnsaddr support in swarm connect ([ipfs/go-ipfs#5535](https://github.com/glvd/starship/pull/5535))
  - make in-memory datastore thread-safe ([ipfs/go-ipfs#6085](https://github.com/glvd/starship/pull/6085))
  - Update package table to remove broken jenkins links ([ipfs/go-ipfs#6084](https://github.com/glvd/starship/pull/6084))
  - mk: fix maketarball to work with gomod ([ipfs/go-ipfs#6078](https://github.com/glvd/starship/pull/6078))
  - fix ls command to use the new coreinterface types ([ipfs/go-ipfs#6051](https://github.com/glvd/starship/pull/6051))
  - mk: remove install_unsupported, leave a note ([ipfs/go-ipfs#6063](https://github.com/glvd/starship/pull/6063))
  - mk: change git-hash command to include information about modifications ([ipfs/go-ipfs#6060](https://github.com/glvd/starship/pull/6060))
  - mk: fix make install by not setting GOBIN ([ipfs/go-ipfs#6059](https://github.com/glvd/starship/pull/6059))
  - go: require Golang 1.11.4 ([ipfs/go-ipfs#6057](https://github.com/glvd/starship/pull/6057))
  - yamux: increase yamux window size to 8MiB. ([ipfs/go-ipfs#6049](https://github.com/glvd/starship/pull/6049))
  - Introduce go modules [yey] ([ipfs/go-ipfs#6038](https://github.com/glvd/starship/pull/6038))
  - cleanup daemon online logic ([ipfs/go-ipfs#6050](https://github.com/glvd/starship/pull/6050))
  - ci: test on 32bit os ([ipfs/go-ipfs#5429](https://github.com/glvd/starship/pull/5429))
  - feat/cmds: hide peers info default in bitswap stat ([ipfs/go-ipfs#5820](https://github.com/glvd/starship/pull/5820))
  - Improve CLI help pages ([ipfs/go-ipfs#6013](https://github.com/glvd/starship/pull/6013))
  - Close #6044 ([ipfs/go-ipfs#6045](https://github.com/glvd/starship/pull/6045))
  - commands(dht): return final error ([ipfs/go-ipfs#6034](https://github.com/glvd/starship/pull/6034))
  - Revert "Really run as non-root user in docker container" ([ipfs/go-ipfs#6040](https://github.com/glvd/starship/pull/6040))
...
([#6002](https://github.com/glvd/starship/issues/6002)).
...
[documentation](https://github.com/glvd/starship/blob/master/docs/experimental-features.md#p2p-http-proxy).
...
[ipfs/go-ipfs#4498]: https://github.com/glvd/starship/issues/4498
...
[daemon-plugin]: https://github.com/glvd/starship/blob/master/docs/plugins.md#daemon

### Changelogs

- github.com/ipfs/go-ipfs:
  - fix: show interactive output from install.sh ([ipfs/go-ipfs#6024](https://github.com/glvd/starship/pull/6024))
  - fix: return the shortest, completely resolved path in the resolve command ([ipfs/go-ipfs#5704](https://github.com/glvd/starship/pull/5704))
  - fix a few interop test issues ([ipfs/go-ipfs#6004](https://github.com/glvd/starship/pull/6004))
  - fix HAMT bookmark ln ([ipfs/go-ipfs#6005](https://github.com/glvd/starship/pull/6005))
  - docs: document Gateway.NoFetch ([ipfs/go-ipfs#5999](https://github.com/glvd/starship/pull/5999))
  - Improve "name publish" ttl option documentation ([ipfs/go-ipfs#5979](https://github.com/glvd/starship/pull/5979))
  - fix(cmd/mv): dst filename error ([ipfs/go-ipfs#5964](https://github.com/glvd/starship/pull/5964))
  - coreapi: extract interface ([ipfs/go-ipfs#5978](https://github.com/glvd/starship/pull/5978))
  - coreapi: cleanup non-gx references ([ipfs/go-ipfs#5976](https://github.com/glvd/starship/pull/5976))
  - coreapi: fix seek test on http impl ([ipfs/go-ipfs#5971](https://github.com/glvd/starship/pull/5971))
  - block put --pin ([ipfs/go-ipfs#5969](https://github.com/glvd/starship/pull/5969))
  - Port `ipfs ls` to CoreAPI ([ipfs/go-ipfs#5962](https://github.com/glvd/starship/pull/5962))
  - docs: duplicate default helptext in `name publish` ([ipfs/go-ipfs#5960](https://github.com/glvd/starship/pull/5960))
  - plugin: add a daemon plugin with access to the CoreAPI ([ipfs/go-ipfs#5955](https://github.com/glvd/starship/pull/5955))
  - coreapi: add some seeker tests ([ipfs/go-ipfs#5934](https://github.com/glvd/starship/pull/5934))
  - Refactor ipfs get to use CoreAPI ([ipfs/go-ipfs#5943](https://github.com/glvd/starship/pull/5943))
  - refact(cmd/init): change string option to const ([ipfs/go-ipfs#5949](https://github.com/glvd/starship/pull/5949))
  - cmds/pin: use coreapi/pin ([ipfs/go-ipfs#5843](https://github.com/glvd/starship/pull/5843))
  - Only perform DNSLink lookups on fully qualified domain names (FQDN) ([ipfs/go-ipfs#5950](https://github.com/glvd/starship/pull/5950))
  - Fix DontCheckOSXFUSE config command example ([ipfs/go-ipfs#5951](https://github.com/glvd/starship/pull/5951))
  - refact(cmd/config): change string option to const ([ipfs/go-ipfs#5948](https://github.com/glvd/starship/pull/5948))
  - clarification the document of --resolve flag in name.publish ([ipfs/go-ipfs#5651](https://github.com/glvd/starship/pull/5651))
  - Drop some coreunix code ([ipfs/go-ipfs#5938](https://github.com/glvd/starship/pull/5938))
  - commands: fix verbose flag ([ipfs/go-ipfs#5940](https://github.com/glvd/starship/pull/5940))
  - Fixes #4558 ([ipfs/go-ipfs#5937](https://github.com/glvd/starship/pull/5937))
  - Port dag commansds to CoreAPI ([ipfs/go-ipfs#5939](https://github.com/glvd/starship/pull/5939))
  - mfs: make sure to flush after mv and chcid ([ipfs/go-ipfs#5936](https://github.com/glvd/starship/pull/5936))
  - docs/code-flow : Add code flow documentation for add cmd. ([ipfs/go-ipfs#5864](https://github.com/glvd/starship/pull/5864))
  - coreapi: few more error check fixes ([ipfs/go-ipfs#5935](https://github.com/glvd/starship/pull/5935))
  - Fixed and cleaned up TestIpfsStressRead ([ipfs/go-ipfs#5920](https://github.com/glvd/starship/pull/5920))
  - Clarify that chunker sizes are in bytes ([ipfs/go-ipfs#5923](https://github.com/glvd/starship/pull/5923))
  - refact(cmd/patch): change string to const ([ipfs/go-ipfs#5931](https://github.com/glvd/starship/pull/5931))
  - refact(cmd/object): change option string to const ([ipfs/go-ipfs#5932](https://github.com/glvd/starship/pull/5932))
  - coreapi: replace coreiface.DagAPI with ipld.DAGService ([ipfs/go-ipfs#5922](https://github.com/glvd/starship/pull/5922))
  - Add global option to specify the multibase encoding (server side) ([ipfs/go-ipfs#5789](https://github.com/glvd/starship/pull/5789))
  - coreapi: Adjust some tests for go-ipfs-http-api ([ipfs/go-ipfs#5926](https://github.com/glvd/starship/pull/5926))
  - chore: update to Web UI v2.3.3 ([ipfs/go-ipfs#5928](https://github.com/glvd/starship/pull/5928))
  - ls: Report real file size ([ipfs/go-ipfs#5906](https://github.com/glvd/starship/pull/5906))
  - Improve the Filestore document ([ipfs/go-ipfs#5927](https://github.com/glvd/starship/pull/5927))
  - [CORS] Bubble go-ipfs-cmds 2.0.10 - Updates CORS library ([ipfs/go-ipfs#5919](https://github.com/glvd/starship/pull/5919))
  - reduce verbosity of daemon start ([ipfs/go-ipfs#5904](https://github.com/glvd/starship/pull/5904))
  - feat: update to Web UI v2.3.2 ([ipfs/go-ipfs#5899](https://github.com/glvd/starship/pull/5899))
  - CoreAPI: Don't panic when testing incomplete implementions ([ipfs/go-ipfs#5900](https://github.com/glvd/starship/pull/5900))
  - gateway: fix CORs headers ([ipfs/go-ipfs#5893](https://github.com/glvd/starship/pull/5893))
  - Local Gateway option ([ipfs/go-ipfs#5649](https://github.com/glvd/starship/pull/5649))
  - Show hash on gateway ([ipfs/go-ipfs#5830](https://github.com/glvd/starship/pull/5830))
  - fix: ulimit docs mistake ([ipfs/go-ipfs#5894](https://github.com/glvd/starship/pull/5894))
  - Move coreapi tests to the interface ([ipfs/go-ipfs#5865](https://github.com/glvd/starship/pull/5865))
  - Move checkHelptextRecursive forward a bit ([ipfs/go-ipfs#5889](https://github.com/glvd/starship/pull/5889))
  - coreapi/unixfs: Use path instead of raw hash in AddEvent ([ipfs/go-ipfs#5854](https://github.com/glvd/starship/pull/5854))
  - Fix name resolve --offline ([ipfs/go-ipfs#5885](https://github.com/glvd/starship/pull/5885))
  - testing: slow down republisher sharness test ([ipfs/go-ipfs#5856](https://github.com/glvd/starship/pull/5856))
  - docs: flesh out plugin documentation ([ipfs/go-ipfs#5876](https://github.com/glvd/starship/pull/5876))
  -  main: move InterruptHandler to util  ([ipfs/go-ipfs#5872](https://github.com/glvd/starship/pull/5872))
  - make: fix building source tarball on macos ([ipfs/go-ipfs#5860](https://github.com/glvd/starship/pull/5860))
  - fix config data race ([ipfs/go-ipfs#5634](https://github.com/glvd/starship/pull/5634))
  - CoreAPI: Global offline option ([ipfs/go-ipfs#5825](https://github.com/glvd/starship/pull/5825))
  - Update for go-ipfs-files refactor ([ipfs/go-ipfs#5661](https://github.com/glvd/starship/pull/5661))
  - feat: update Web UI to v2.3.0 ([ipfs/go-ipfs#5855](https://github.com/glvd/starship/pull/5855))
  - Stateful plugin loading ([ipfs/go-ipfs#4806](https://github.com/glvd/starship/pull/4806))
  - startup: always load the private key ([ipfs/go-ipfs#5844](https://github.com/glvd/starship/pull/5844))
  - add --dereference-args parameter ([ipfs/go-ipfs#5801](https://github.com/glvd/starship/pull/5801))
  - config: document the connection manager ([ipfs/go-ipfs#5839](https://github.com/glvd/starship/pull/5839))
  - add pinning support to the urlstore ([ipfs/go-ipfs#5834](https://github.com/glvd/starship/pull/5834))
  - refact(cmd/cat): remove useless code ([ipfs/go-ipfs#5836](https://github.com/glvd/starship/pull/5836))
  - Really run as non-root user in docker container ([ipfs/go-ipfs#5048](https://github.com/glvd/starship/pull/5048))
  - README: document guix package ([ipfs/go-ipfs#5832](https://github.com/glvd/starship/pull/5832))
  - docs: Improve config documentation ([ipfs/go-ipfs#5829](https://github.com/glvd/starship/pull/5829))
  - block: rm extra output ([ipfs/go-ipfs#5751](https://github.com/glvd/starship/pull/5751))
  - merge github-issue-guide with the issue template ([ipfs/go-ipfs#4636](https://github.com/glvd/starship/pull/4636))
  - docs: fix inconsistent capitalization of "API". ([ipfs/go-ipfs#5824](https://github.com/glvd/starship/pull/5824))
  - Update README.md ([ipfs/go-ipfs#5818](https://github.com/glvd/starship/pull/5818))
  - CONTRIBUTING.md link ([ipfs/go-ipfs#5811](https://github.com/glvd/starship/pull/5811))
  - README: Update required Go version ([ipfs/go-ipfs#5813](https://github.com/glvd/starship/pull/5813))
  - p2p: report-peer-id option for listen ([ipfs/go-ipfs#5771](https://github.com/glvd/starship/pull/5771))
  - really fix netcat race ([ipfs/go-ipfs#5803](https://github.com/glvd/starship/pull/5803))
  - [http_proxy_over_p2p] ([ipfs/go-ipfs#5526](https://github.com/glvd/starship/pull/5526))
  - coreapi/pin: Use CID's directly in maps instead of converting to string ([ipfs/go-ipfs#5809](https://github.com/glvd/starship/pull/5809))
  - Gx update go-merkledag and related deps. ([ipfs/go-ipfs#5802](https://github.com/glvd/starship/pull/5802))
  - cmds: rm old lib ([ipfs/go-ipfs#5786](https://github.com/glvd/starship/pull/5786))
  - badger: add truncate flag ([ipfs/go-ipfs#5625](https://github.com/glvd/starship/pull/5625))
  - docker: allow IPFS_PROFILE to choose the profile for `ipfs init` ([ipfs/go-ipfs#5473](https://github.com/glvd/starship/pull/5473))
  - Add --stream option to `ls` command ([ipfs/go-ipfs#5611](https://github.com/glvd/starship/pull/5611))
  - Switch to using request.Context() ([ipfs/go-ipfs#5782](https://github.com/glvd/starship/pull/5782))
  - Update go-ipfs-delay and assoc deps ([ipfs/go-ipfs#5762](https://github.com/glvd/starship/pull/5762))
  - Suppress bootstrap error ([ipfs/go-ipfs#5769](https://github.com/glvd/starship/pull/5769))
  - ISSUE_TEMPLATE: move the support question comment to the very top ([ipfs/go-ipfs#5770](https://github.com/glvd/starship/pull/5770))
  - cmds: use MakeTypedEncoder ([ipfs/go-ipfs#5760](https://github.com/glvd/starship/pull/5760))
  - cmds/bitswap: sort wantlist ([ipfs/go-ipfs#5759](https://github.com/glvd/starship/pull/5759))
  - cmds/update: use new cmds lib ([ipfs/go-ipfs#5730](https://github.com/glvd/starship/pull/5730))
  - cmds/file: use new cmds lib ([ipfs/go-ipfs#5756](https://github.com/glvd/starship/pull/5756))
  - cmds: remove reduntant func ([ipfs/go-ipfs#5750](https://github.com/glvd/starship/pull/5750))
  - commands/refs: use new cmds ([ipfs/go-ipfs#5679](https://github.com/glvd/starship/pull/5679))
  - commands/pin: use new cmds lib ([ipfs/go-ipfs#5674](https://github.com/glvd/starship/pull/5674))
  - commands/boostrap: use new cmds ([ipfs/go-ipfs#5678](https://github.com/glvd/starship/pull/5678))
  - fix(cmd/add): progressbar output error when input is read from stdin ([ipfs/go-ipfs#5743](https://github.com/glvd/starship/pull/5743))
  - unexport GOFLAGS ([ipfs/go-ipfs#5747](https://github.com/glvd/starship/pull/5747))
  - refactor(cmds): use new cmds ([ipfs/go-ipfs#5659](https://github.com/glvd/starship/pull/5659))
  - commands/filestore: use new cmds lib ([ipfs/go-ipfs#5673](https://github.com/glvd/starship/pull/5673))
  - Fix broken links ([ipfs/go-ipfs#5721](https://github.com/glvd/starship/pull/5721))
  - fix `ipfs help` bug #5557 ([ipfs/go-ipfs#5573](https://github.com/glvd/starship/pull/5573))
  - commands/bitswap: use new cmds lib ([ipfs/go-ipfs#5676](https://github.com/glvd/starship/pull/5676))
  - refact(cmd/repo): repo's sub cmds uses new cmd lib ([ipfs/go-ipfs#5677](https://github.com/glvd/starship/pull/5677))
  - fix the maketarball script ([ipfs/go-ipfs#5718](https://github.com/glvd/starship/pull/5718))
  - output link to WebUI on daemon startup ([ipfs/go-ipfs#5729](https://github.com/glvd/starship/pull/5729))
  - Move persistent datastores to plugins ([ipfs/go-ipfs#5695](https://github.com/glvd/starship/pull/5695))
  - Update IPTB test ([ipfs/go-ipfs#5636](https://github.com/glvd/starship/pull/5636))
  - enhance(cmd/verify): add goroutine count to improve verify speed ([ipfs/go-ipfs#5710](https://github.com/glvd/starship/pull/5710))
  - Update go-mfs and go-unixfs ([ipfs/go-ipfs#5714](https://github.com/glvd/starship/pull/5714))
  - fix(flag/version): flag `all` should have a higher priority ([ipfs/go-ipfs#5719](https://github.com/glvd/starship/pull/5719))
  - commands/p2p: use new cmds lib ([ipfs/go-ipfs#5672](https://github.com/glvd/starship/pull/5672))
  - commands/dht: use new cmds lib ([ipfs/go-ipfs#5671](https://github.com/glvd/starship/pull/5671))
  - commands/object: use new cmds ([ipfs/go-ipfs#5666](https://github.com/glvd/starship/pull/5666))
  - commands/files: use new cmds ([ipfs/go-ipfs#5665](https://github.com/glvd/starship/pull/5665))
  - cmds/env: add a config path helper ([ipfs/go-ipfs#5712](https://github.com/glvd/starship/pull/5712))
...
[here](https://github.com/glvd/starship/blob/master/docs/experimental-features.md#QUIC).
...
[here](https://github.com/glvd/starship/blob/master/docs/experimental-features.md#gossipsub).
...
[here](https://github.com/glvd/starship/blob/master/docs/experimental-features.md#message-signing).
...
documentation 
[here](https://github.com/glvd/starship/blob/master/docs/experimental-features.md#ipfs-p2p).
...
You can track progress in https://github.com/glvd/starship/issues/4498
...
Features (i.e., users take heed):
  - gossipsub ([ipfs/go-ipfs#5373](https://github.com/glvd/starship/pull/5373))
  - support /ipfs/CID in `ipfs dht findprovs` ([ipfs/go-ipfs#5329](https://github.com/glvd/starship/pull/5329))
  - return a json object from config show ([ipfs/go-ipfs#5345](https://github.com/glvd/starship/pull/5345))
  - Set filename in Content-Disposition if filename=x is passed in URI query ([ipfs/go-ipfs#4177](https://github.com/glvd/starship/pull/4177))
  - Allow mfs files.write command to create parent directories ([ipfs/go-ipfs#5359](https://github.com/glvd/starship/pull/5359))
  - Run DNS lookup for --api endpoint provided in CLI ([ipfs/go-ipfs#5372](https://github.com/glvd/starship/pull/5372))
  - Add support for inlinling blocks into CIDs the id-hash ([ipfs/go-ipfs#5281](https://github.com/glvd/starship/pull/5281))
  - depth limited refs -r ([ipfs/go-ipfs#5337](https://github.com/glvd/starship/pull/5337))
  - remove bitswap unwant ([ipfs/go-ipfs#5308](https://github.com/glvd/starship/pull/5308))
  - add experimental QUIC support ([ipfs/go-ipfs#5350](https://github.com/glvd/starship/pull/5350))
  - add a --stdin-name flag for naming files from stdin ([ipfs/go-ipfs#5399](https://github.com/glvd/starship/pull/5399))
  - Refactor `ipfs p2p` ([ipfs/go-ipfs#4929](https://github.com/glvd/starship/pull/4929))
  - add dns support in`ipfs p2p forward` and refactor code ([ipfs/go-ipfs#5533](https://github.com/glvd/starship/pull/5533))
  - feat(command): expose connection direction ([ipfs/go-ipfs#5457](https://github.com/glvd/starship/pull/5457))
  - error when publishing ipns records without a running daemon ([ipfs/go-ipfs#5477](https://github.com/glvd/starship/pull/5477))
  - feat(daemon): print version on start ([ipfs/go-ipfs#5503](https://github.com/glvd/starship/pull/5503))
  - add quieter option to name publish ([ipfs/go-ipfs#5494](https://github.com/glvd/starship/pull/5494))
  - Provide new "cid" sub-command. ([ipfs/go-ipfs#5385](https://github.com/glvd/starship/pull/5385))
  - feat(command): add force flag for files rm ([ipfs/go-ipfs#5555](https://github.com/glvd/starship/pull/5555))
  - Add support for datastore plugins ([ipfs/go-ipfs#5187](https://github.com/glvd/starship/pull/5187))
  - files ls: append slash to directory names ([ipfs/go-ipfs#5605](https://github.com/glvd/starship/pull/5605))
  - ipfs name resolve --stream ([ipfs/go-ipfs#5404](https://github.com/glvd/starship/pull/5404))
  - update webui to 2.1.0 ([ipfs/go-ipfs#5627](https://github.com/glvd/starship/pull/5627))
  - feat: add dry-run flag for config profile apply command ([ipfs/go-ipfs#5455](https://github.com/glvd/starship/pull/5455))
  - configurable pubsub signing ([ipfs/go-ipfs#5647](https://github.com/glvd/starship/pull/5647))

Fixes (i.e., users take note):
  - pin update fixes ([ipfs/go-ipfs#5265](https://github.com/glvd/starship/pull/5265))
  - Fix inability to pin two things at once ([ipfs/go-ipfs#5512](https://github.com/glvd/starship/pull/5512))
  - wait for all connections to close before exiting on shutdown. ([ipfs/go-ipfs#5322](https://github.com/glvd/starship/pull/5322))
  - Fixed ipns address resolution in fuse unix mount ([ipfs/go-ipfs#5384](https://github.com/glvd/starship/pull/5384))
  - core/commands/ls: wrap `NewDirectoryFromNode` error ([ipfs/go-ipfs#5166](https://github.com/glvd/starship/pull/5166))
  - fix goroutine leaks in filestore.go ([ipfs/go-ipfs#5427](https://github.com/glvd/starship/pull/5427))
  - move VersionOption after GatewayOption to fix #5422 ([ipfs/go-ipfs#5424](https://github.com/glvd/starship/pull/5424))
  - fix(commands): fix filestore.go goroutine leak ([ipfs/go-ipfs#5439](https://github.com/glvd/starship/pull/5439))
  - fix(commands): goroutine leaks in ping.go ([ipfs/go-ipfs#5444](https://github.com/glvd/starship/pull/5444))
  - fix output of object command ([ipfs/go-ipfs#5459](https://github.com/glvd/starship/pull/5459))
  - add warning when no bootstrap in config ([ipfs/go-ipfs#5445](https://github.com/glvd/starship/pull/5445))
  - fix behaviour of key rename to same name ([ipfs/go-ipfs#5465](https://github.com/glvd/starship/pull/5465))
  - fix(object): print object diff error ([ipfs/go-ipfs#5469](https://github.com/glvd/starship/pull/5469))
  - fix(pin): goroutine leaks ([ipfs/go-ipfs#5453](https://github.com/glvd/starship/pull/5453))
  - fix offline id bug ([ipfs/go-ipfs#5486](https://github.com/glvd/starship/pull/5486))
  - files cp: improve flush error message ([ipfs/go-ipfs#5485](https://github.com/glvd/starship/pull/5485))
  - resolve: fix unixfs resolution through sharded directories ([ipfs/go-ipfs#5484](https://github.com/glvd/starship/pull/5484))
  - Switch name publish/resolve to coreapi ([ipfs/go-ipfs#5563](https://github.com/glvd/starship/pull/5563))
  - use CoreAPI resolver everywhere (fixes sharded directory resolution) ([ipfs/go-ipfs#5492](https://github.com/glvd/starship/pull/5492))
  - add pin lock in AddallPin function ([ipfs/go-ipfs#5506](https://github.com/glvd/starship/pull/5506))
  - take the pinlock when updating pins ([ipfs/go-ipfs#5550](https://github.com/glvd/starship/pull/5550))
  - fix(object): add support for raw leaves in object diff ([ipfs/go-ipfs#5472](https://github.com/glvd/starship/pull/5472))
  - don't use the domain name as a filename in /ipns/a.com ([ipfs/go-ipfs#5564](https://github.com/glvd/starship/pull/5564))
  - refactor(command): modify int to int64 ([ipfs/go-ipfs#5612](https://github.com/glvd/starship/pull/5612))
  - fix(core): ipns config RecordLifetime panic ([ipfs/go-ipfs#5648](https://github.com/glvd/starship/pull/5648))
  - simplify dag put and correctly take pin lock ([ipfs/go-ipfs#5667](https://github.com/glvd/starship/pull/5667))
  - fix prometheus concurrent map write bug ([ipfs/go-ipfs#5706](https://github.com/glvd/starship/pull/5706))

Regressions Fixes (fixes for bugs introduced since the last release):
  - namesys: properly attach path in name.Resolve ([ipfs/go-ipfs#5660](https://github.com/glvd/starship/pull/5660))
  - fix(p2p): issue #5523 ([ipfs/go-ipfs#5529](https://github.com/glvd/starship/pull/5529))
  - fix infinite loop in `stats bw` ([ipfs/go-ipfs#5598](https://github.com/glvd/starship/pull/5598))
  - make warnings on no bootstrap peers less noisy ([ipfs/go-ipfs#5466](https://github.com/glvd/starship/pull/5466))
  - fix two transport related bugs ([ipfs/go-ipfs#5417](https://github.com/glvd/starship/pull/5417))
  - Fix pin ls output when hash is specified ([ipfs/go-ipfs#5699](https://github.com/glvd/starship/pull/5699))
  - ping: switch to the ping service enabled in the libp2p constructor ([ipfs/go-ipfs#5698](https://github.com/glvd/starship/pull/5698))
  - commands: fix a bunch of tiny commands-lib issues ([ipfs/go-ipfs#5697](https://github.com/glvd/starship/pull/5697))
  - cleanup the ping command ([ipfs/go-ipfs#5680](https://github.com/glvd/starship/pull/5680))
  - fix gossipsub goroutine explosion ([ipfs/go-ipfs#5688](https://github.com/glvd/starship/pull/5688))
  - fix(cmd/gc): Run func does not return error when Emit func returns error ([ipfs/go-ipfs#5687](https://github.com/glvd/starship/pull/5687))

Extractions:
  - Extract bitswap to go-bitswap ([ipfs/go-ipfs#5294](https://github.com/glvd/starship/pull/5294))
  - Extract blockservice and verifcid ([ipfs/go-ipfs#5296](https://github.com/glvd/starship/pull/5296))
  - Extract merkledag package, move dagutils to top level ([ipfs/go-ipfs#5298](https://github.com/glvd/starship/pull/5298))
  - Extract path and resolver ([ipfs/go-ipfs#5306](https://github.com/glvd/starship/pull/5306))
  - Extract config package ([ipfs/go-ipfs#5277](https://github.com/glvd/starship/pull/5277))
  - Extract unixfs and importers to go-unixfs ([ipfs/go-ipfs#5316](https://github.com/glvd/starship/pull/5316))
  - delete unixfs code... ([ipfs/go-ipfs#5319](https://github.com/glvd/starship/pull/5319))
  - Extract /mfs to github.com/ipfs/go-mfs ([ipfs/go-ipfs#5391](https://github.com/glvd/starship/pull/5391))
  - re-format log output as ndjson ([ipfs/go-ipfs#5708](https://github.com/glvd/starship/pull/5708))
  - error on resolving non-terminal paths ([ipfs/go-ipfs#5705](https://github.com/glvd/starship/pull/5705))

Documentation:
  - document the fact that we now publish releases on GitHub ([ipfs/go-ipfs#5301](https://github.com/glvd/starship/pull/5301))
  - docs: add url to dev weekly sync to the README ([ipfs/go-ipfs#5371](https://github.com/glvd/starship/pull/5371))
  - docs: README refresh, add cli-http-api-core diagram ([ipfs/go-ipfs#5396](https://github.com/glvd/starship/pull/5396))
  - add some basic gateway documentation ([ipfs/go-ipfs#5393](https://github.com/glvd/starship/pull/5393))
  - fix the default gateway port ([ipfs/go-ipfs#5419](https://github.com/glvd/starship/pull/5419))
  - fix order of events in the release process ([ipfs/go-ipfs#5434](https://github.com/glvd/starship/pull/5434))
  - docs: add some minimal read-only API documentation ([ipfs/go-ipfs#5437](https://github.com/glvd/starship/pull/5437))
  - feat: use package-table ([ipfs/go-ipfs#5395](https://github.com/glvd/starship/pull/5395))
  - link to go-{libp2p,ipld} package tables ([ipfs/go-ipfs#5446](https://github.com/glvd/starship/pull/5446))
  - api: fix outdated HTTPHeaders config documentation ([ipfs/go-ipfs#5451](https://github.com/glvd/starship/pull/5451))
  - add version, usage, and planning info for urlstore ([ipfs/go-ipfs#5552](https://github.com/glvd/starship/pull/5552))
  - debug-guide.md added memory statistics command ([ipfs/go-ipfs#5546](https://github.com/glvd/starship/pull/5546))
  - Change to point to combined go contributing guidelines ([ipfs/go-ipfs#5607](https://github.com/glvd/starship/pull/5607))
  - docs: Update link format ([ipfs/go-ipfs#5617](https://github.com/glvd/starship/pull/5617))
  - Fix link in readme ([ipfs/go-ipfs#5632](https://github.com/glvd/starship/pull/5632))
  - docs: add a note for dns command ([ipfs/go-ipfs#5629](https://github.com/glvd/starship/pull/5629))
  - Dockerfile: Specifies comments on exposed ports ([ipfs/go-ipfs#5615](https://github.com/glvd/starship/pull/5615))
  - document pubsub message signing ([ipfs/go-ipfs#5669](https://github.com/glvd/starship/pull/5669))

Testing:
  - Include cid-fmt binary in test/bin. ([ipfs/go-ipfs#5297](https://github.com/glvd/starship/pull/5297))
  - wait for the nodes to fully stop ([ipfs/go-ipfs#5315](https://github.com/glvd/starship/pull/5315))
  - apply timeout for build steps after getting node ([ipfs/go-ipfs#5313](https://github.com/glvd/starship/pull/5313))
  - ci: check for gx deps dupes ([ipfs/go-ipfs#5338](https://github.com/glvd/starship/pull/5338))
  - ci: call cleanWs after each step ([ipfs/go-ipfs#5374](https://github.com/glvd/starship/pull/5374))
  - add correct test for GC completeness ([ipfs/go-ipfs#5364](https://github.com/glvd/starship/pull/5364))
  - fix the urlstore tests ([ipfs/go-ipfs#5397](https://github.com/glvd/starship/pull/5397))
  - improve gateway options test ([ipfs/go-ipfs#5433](https://github.com/glvd/starship/pull/5433))
  - coreapi name: Increase test swarm size ([ipfs/go-ipfs#5481](https://github.com/glvd/starship/pull/5481))
  - fix fuse unmount test ([ipfs/go-ipfs#5476](https://github.com/glvd/starship/pull/5476))
  - test(add): add test for issue \#5456 ([ipfs/go-ipfs#5493](https://github.com/glvd/starship/pull/5493))
  - fixed tests of raised fd limits ([ipfs/go-ipfs#5496](https://github.com/glvd/starship/pull/5496))
  - pprof: create HTTP endpoint for setting MutexProfileFraction ([ipfs/go-ipfs#5527](https://github.com/glvd/starship/pull/5527))
  - fix(command):update `add --chunker` test ([ipfs/go-ipfs#5571](https://github.com/glvd/starship/pull/5571))
  - switch to go 1.11 ([ipfs/go-ipfs#5483](https://github.com/glvd/starship/pull/5483))
  - fix: sharness race in directory_size if file is removed ([ipfs/go-ipfs#5586](https://github.com/glvd/starship/pull/5586))
  - Bump Go versions and use '.x' to always get latest minor versions ([ipfs/go-ipfs#5682](https://github.com/glvd/starship/pull/5682))
  - add rabin min error test ([ipfs/go-ipfs#5449](https://github.com/glvd/starship/pull/5449))
  - Use CircleCI 2.0 ([ipfs/go-ipfs#5691](https://github.com/glvd/starship/pull/5691))

Internal:
  - Add ability to retrieve blocks even if given using a different CID version ([ipfs/go-ipfs#5285](https://github.com/glvd/starship/pull/5285))
  - update gogo-protobuf ([ipfs/go-ipfs#5355](https://github.com/glvd/starship/pull/5355))
  - update protobuf files in go-ipfs ([ipfs/go-ipfs#5356](https://github.com/glvd/starship/pull/5356))
  - string-backed CIDs ([ipfs/go-ipfs#5441](https://github.com/glvd/starship/pull/5441))
  - commands: switch object to CoreAPI ([ipfs/go-ipfs#4643](https://github.com/glvd/starship/pull/4643))
  - coreapi: dag: Batching interface ([ipfs/go-ipfs#5340](https://github.com/glvd/starship/pull/5340))
  - key cmd: Refactor to use coreapi ([ipfs/go-ipfs#5339](https://github.com/glvd/starship/pull/5339))
  - coreapi: DHT API ([ipfs/go-ipfs#4804](https://github.com/glvd/starship/pull/4804))
  - block cmd: Use coreapi ([ipfs/go-ipfs#5331](https://github.com/glvd/starship/pull/5331))
  - mk: embed CurrentCommit in the right place ([ipfs/go-ipfs#5507](https://github.com/glvd/starship/pull/5507))
  - added binary executable files to .dockerignore ([ipfs/go-ipfs#5544](https://github.com/glvd/starship/pull/5544))
  - Add sessions when fetching MerkleDAG in LS ([ipfs/go-ipfs#5509](https://github.com/glvd/starship/pull/5509))
  - coreapi: Swarm API ([ipfs/go-ipfs#4803](https://github.com/glvd/starship/pull/4803))
  - coreapi swarm: unify impl type with other apis ([ipfs/go-ipfs#5551](https://github.com/glvd/starship/pull/5551))
  - Refactor UnixFS CoreAPI ([ipfs/go-ipfs#5501](https://github.com/glvd/starship/pull/5501))
  - coreapi: PubSub API ([ipfs/go-ipfs#4805](https://github.com/glvd/starship/pull/4805))
  - fix: maketarball.sh for OSX ([ipfs/go-ipfs#5575](https://github.com/glvd/starship/pull/5575))
  - test the correct return value when checking directory size ([ipfs/go-ipfs#5580](https://github.com/glvd/starship/pull/5580))
  - coreapi unixfs: remove Cat ([ipfs/go-ipfs#5574](https://github.com/glvd/starship/pull/5574))
  - Explicitally use BufferedDAG after removing Batch from importers ([ipfs/go-ipfs#5626](https://github.com/glvd/starship/pull/5626))

Cleanup:
  - Fix some weird code in core/coreunix/add.go ([ipfs/go-ipfs#5354](https://github.com/glvd/starship/pull/5354))
  - name cmd: move subcommands to subdirectory ([ipfs/go-ipfs#5392](https://github.com/glvd/starship/pull/5392))
  - directly parse peer IDs as peer IDs ([ipfs/go-ipfs#5409](https://github.com/glvd/starship/pull/5409))
  - don't bother caching if we're using a nil repo ([ipfs/go-ipfs#5414](https://github.com/glvd/starship/pull/5414))
  - object:refactor data encode error ([ipfs/go-ipfs#5426](https://github.com/glvd/starship/pull/5426))
  - remove Godeps ([ipfs/go-ipfs#5440](https://github.com/glvd/starship/pull/5440))
  - update for the go-ipfs-cmds refactor ([ipfs/go-ipfs#5035](https://github.com/glvd/starship/pull/5035))
  - fix(unixfs): issue #5217 (Avoid use of `pb.Data`) ([ipfs/go-ipfs#5505](https://github.com/glvd/starship/pull/5505))
  - fix(unixfs): issue #5055 ([ipfs/go-ipfs#5525](https://github.com/glvd/starship/pull/5525))
  - add offline id test #4978 and refactor command code ([ipfs/go-ipfs#5562](https://github.com/glvd/starship/pull/5562))
  - refact(command): replace option name with const string ([ipfs/go-ipfs#5642](https://github.com/glvd/starship/pull/5642))
  - remove p2p-circuit addr hack in ipfs swarm peers ([ipfs/go-ipfs#5645](https://github.com/glvd/starship/pull/5645))
  - refactor(commands/id): use new command ([ipfs/go-ipfs#5646](https://github.com/glvd/starship/pull/5646))
  - object patch rm-link: change arg from 'link' to 'name' ([ipfs/go-ipfs#5638](https://github.com/glvd/starship/pull/5638))
  - refactor(cmds): use new cmds lib in version, tar and dns ([ipfs/go-ipfs#5650](https://github.com/glvd/starship/pull/5650))
  - cmds/dag: use new cmds lib ([ipfs/go-ipfs#5662](https://github.com/glvd/starship/pull/5662))
  - commands/ping: use new cmds lib ([ipfs/go-ipfs#5675](https://github.com/glvd/starship/pull/5675))
...
[urlstore]: https://github.com/glvd/starship/blob/master/docs/experimental-features.md#ipfs-urlstore

Features:

* URLStore ([ipfs/go-ipfs#4896](https://github.com/glvd/starship/pull/4896))
* Add trickle-dag support to the urlstore ([ipfs/go-ipfs#5245](https://github.com/glvd/starship/pull/5245)).
* Allow specifying how the data field in the `object get` is encoded ([ipfs/go-ipfs#5139](https://github.com/glvd/starship/pull/5139))
* Add a `-U` flag to `files ls` to disable sorting ([ipfs/go-ipfs#5219](https://github.com/glvd/starship/pull/5219))
* Add an efficient `--size-only` flag to the `repo stat` ([ipfs/go-ipfs#5010](https://github.com/glvd/starship/pull/5010))
* Inline blocks in CIDs ([ipfs/go-ipfs#5117](https://github.com/glvd/starship/pull/5117))

Changes/Fixes:

* Make `ipfs files ls -l` correctly report the hash and size of files ([ipfs/go-ipfs#5045](https://github.com/glvd/starship/pull/5045))
* Fix sorting of `files ls` ([ipfs/go-ipfs#5219](https://github.com/glvd/starship/pull/5219))
* Improve prefetching in `ipfs cat` and related commands ([ipfs/go-ipfs#5162](https://github.com/glvd/starship/pull/5162))
* Better error message when `ipfs cp` fails ([ipfs/go-ipfs#5218](https://github.com/glvd/starship/pull/5218))
* Don't wait for the peer to close it's end of a bitswap stream before considering the block "sent" ([ipfs/go-ipfs#5258](https://github.com/glvd/starship/pull/5258))
* Fix resolving links in sharded directories via the gateway ([ipfs/go-ipfs#5271](https://github.com/glvd/starship/pull/5271))
* Fix building when there's a space in the current directory ([ipfs/go-ipfs#5261](https://github.com/glvd/starship/pull/5261))

Documentation:

* Improve documentation about the bloomfilter config options ([ipfs/go-ipfs#4924](https://github.com/glvd/starship/pull/4924))

General refactorings and internal bug fixes:

* Remove the `Offset()` method from the DAGReader ([ipfs/go-ipfs#5190](https://github.com/glvd/starship/pull/5190))
* Fix TestLargeWriteChunks seek behavior ([ipfs/go-ipfs#5276](https://github.com/glvd/starship/pull/5276))
* Add a build tag to disable dynamic plugins ([ipfs/go-ipfs#5274](https://github.com/glvd/starship/pull/5274))
* Use FSNode instead of the Protobuf structure in PBDagReader ([ipfs/go-ipfs#5189](https://github.com/glvd/starship/pull/5189))
* Remove support for non-directory MFS roots ([ipfs/go-ipfs#5170](https://github.com/glvd/starship/pull/5170))
* Remove `UnixfsNode` from the balanced builder ([ipfs/go-ipfs#5118](https://github.com/glvd/starship/pull/5118))
* Fix truncating files (internal) when already at the correct size ([ipfs/go-ipfs#5253](https://github.com/glvd/starship/pull/5253))
* Fix `dagTruncate` (internal) to preserve the node type ([ipfs/go-ipfs#5216](https://github.com/glvd/starship/pull/5216))
* Add an internal interface for unixfs directories ([ipfs/go-ipfs#5160](https://github.com/glvd/starship/pull/5160))
* Refactor the CoreAPI path types and interfaces ([ipfs/go-ipfs#4672](https://github.com/glvd/starship/pull/4672))
* Refactor `precalcNextBuf` in the dag reader ([ipfs/go-ipfs#5237](https://github.com/glvd/starship/pull/5237))
* Update a bunch of dependencies that haven't been updated for a while ([ipfs/go-ipfs#5268](https://github.com/glvd/starship/pull/5268))
...
- Bugfixes
  - Fix dht commands when ipns over pubsub is enabled ([ipfs/go-ipfs#5200](https://github.com/glvd/starship/pull/5200))
  - Fix content routing when ipns over pubsub is enabled ([ipfs/go-ipfs#5200](https://github.com/glvd/starship/pull/5200))
  - Correctly handle multi-hop dnslink resolution ([ipfs/go-ipfs#5202](https://github.com/glvd/starship/pull/5202))

## 0.4.16-rc2 2018-07-05
- Bugfixes
  - Fix usage of file name vs path name in adder ([ipfs/go-ipfs#5167](https://github.com/glvd/starship/pull/5167))
  - Fix `ipfs update` working with migrations ([ipfs/go-ipfs#5194](https://github.com/glvd/starship/pull/5194))
- Documentation
  - Grammar fix in fuse docs ([ipfs/go-ipfs#5164](https://github.com/glvd/starship/pull/5164))

## 0.4.16-rc1 2018-06-27
- Features
  - Embed public keys inside ipns records, use for validation ([ipfs/go-ipfs#5079](https://github.com/glvd/starship/pull/5079))
  - Preload git plugin by default ([ipfs/go-ipfs#4991](https://github.com/glvd/starship/pull/4991))
- Improvements
  - Only resolve dnslinks once in the gateway ([ipfs/go-ipfs#4977](https://github.com/glvd/starship/pull/4977))
  - Libp2p transport refactor update ([ipfs/go-ipfs#4817](https://github.com/glvd/starship/pull/4817))
  - Improve swarm connect/disconnect commands ([ipfs/go-ipfs#5107](https://github.com/glvd/starship/pull/5107))
- Documentation
  - Fix typo of sudo install command ([ipfs/go-ipfs#5001](https://github.com/glvd/starship/pull/5001))
  - Fix experimental features Table of Contents ([ipfs/go-ipfs#4976](https://github.com/glvd/starship/pull/4976))
  - Fix link to systemd init scripts in the README ([ipfs/go-ipfs#4968](https://github.com/glvd/starship/pull/4968))
  - Add package overview comments to coreapi ([ipfs/go-ipfs#5108](https://github.com/glvd/starship/pull/5108))
  - Add README to docs folder ([ipfs/go-ipfs#5095](https://github.com/glvd/starship/pull/5095))
  - Add system requirements to README ([ipfs/go-ipfs#5137](https://github.com/glvd/starship/pull/5137))
- Bugfixes
  - Fix goroutine leak in pin verify ([ipfs/go-ipfs#5011](https://github.com/glvd/starship/pull/5011))
  - Fix commit string in version ([ipfs/go-ipfs#4982](https://github.com/glvd/starship/pull/4982))
  - Fix `key rename` command output error ([ipfs/go-ipfs#4962](https://github.com/glvd/starship/pull/4962))
  - Report error source when failing to construct private network ([ipfs/go-ipfs#4952](https://github.com/glvd/starship/pull/4952))
  - Fix build on DragonFlyBSD ([ipfs/go-ipfs#5031](https://github.com/glvd/starship/pull/5031))
  - Fix goroutine leak in dag put ([ipfs/go-ipfs#5016](https://github.com/glvd/starship/pull/5016))
  - Fix goroutine leaks in refs.go ([ipfs/go-ipfs#5018](https://github.com/glvd/starship/pull/5018))
  - Fix panic, Don't handle errors with fallthrough ([ipfs/go-ipfs#5072](https://github.com/glvd/starship/pull/5072))
  - Fix how filestore is hooked up with caching ([ipfs/go-ipfs#5122](https://github.com/glvd/starship/pull/5122))
  - Add record validation to offline routing ([ipfs/go-ipfs#5116](https://github.com/glvd/starship/pull/5116))
  - Fix `ipfs update` working with migrations ([ipfs/go-ipfs#5194](https://github.com/glvd/starship/pull/5194))
- General Changes and Refactorings
  - Remove leftover bits of dead code ([ipfs/go-ipfs#5022](https://github.com/glvd/starship/pull/5022))
  - Remove fuse platform build constraints ([ipfs/go-ipfs#5033](https://github.com/glvd/starship/pull/5033))
  - Warning when legacy NoSync setting is set ([ipfs/go-ipfs#5036](https://github.com/glvd/starship/pull/5036))
  - Clean up and refactor namesys module ([ipfs/go-ipfs#5007](https://github.com/glvd/starship/pull/5007))
  - When raw-leaves are used for empty files use 'Raw' nodes ([ipfs/go-ipfs#4693](https://github.com/glvd/starship/pull/4693))
  - Update dist_root in build scripts ([ipfs/go-ipfs#5093](https://github.com/glvd/starship/pull/5093))
  - Integrate `pb.Data` into `FSNode` to avoid duplicating fields ([ipfs/go-ipfs#5098](https://github.com/glvd/starship/pull/5098))
  - Reduce log level when we can't republish ([ipfs/go-ipfs#5091](https://github.com/glvd/starship/pull/5091))
  - Extract ipns record logic to go-ipns ([ipfs/go-ipfs#5124](https://github.com/glvd/starship/pull/5124))
- Testing
  - Collect test times for sharness ([ipfs/go-ipfs#4959](https://github.com/glvd/starship/pull/4959))
  - Fix sharness iptb connect timeout ([ipfs/go-ipfs#4966](https://github.com/glvd/starship/pull/4966))
  - Add more timeouts to the jenkins pipeline ([ipfs/go-ipfs#4958](https://github.com/glvd/starship/pull/4958))
  - Use go 1.10 on jenkins ([ipfs/go-ipfs#5009](https://github.com/glvd/starship/pull/5009))
  - Speed up multinode sharness test ([ipfs/go-ipfs#4967](https://github.com/glvd/starship/pull/4967))
  - Print out iptb logs on iptb test failure (for debugging CI) ([ipfs/go-ipfs#5069](https://github.com/glvd/starship/pull/5069))
  - Disable the MacOS tests in jenkins ([ipfs/go-ipfs#5119](https://github.com/glvd/starship/pull/5119))
  - Make republisher test robust against timing issues ([ipfs/go-ipfs#5125](https://github.com/glvd/starship/pull/5125))
  - Archive sharness trash dirs in jenkins ([ipfs/go-ipfs#5071](https://github.com/glvd/starship/pull/5071))
  - Fixup DHT sharness tests ([ipfs/go-ipfs#5114](https://github.com/glvd/starship/pull/5114))
- Dependencies
  - Update go-ipld-git to fix mergetag resolving ([ipfs/go-ipfs#4988](https://github.com/glvd/starship/pull/4988))
  - Fix duplicate /x/sys imports ([ipfs/go-ipfs#5068](https://github.com/glvd/starship/pull/5068))
  - Update stream multiplexers ([ipfs/go-ipfs#5075](https://github.com/glvd/starship/pull/5075))
  - Update dependencies: go-log, sys, go-crypto ([ipfs/go-ipfs#5100](https://github.com/glvd/starship/pull/5100))
  - Explicitly import go-multiaddr-dns in config/bootstrap_peers ([ipfs/go-ipfs#5144](https://github.com/glvd/starship/pull/5144))
  - Gx update with dht and dialing improvements ([ipfs/go-ipfs#5158](https://github.com/glvd/starship/pull/5158))
...
- Features
  - Add options for record count and timeout for resolving DHT paths ([ipfs/go-ipfs#4733](https://github.com/glvd/starship/pull/4733))
  - Add low power init profile ([ipfs/go-ipfs#4154](https://github.com/glvd/starship/pull/4154))
  - Add Opentracing plugin support ([ipfs/go-ipfs#4506](https://github.com/glvd/starship/pull/4506))
  - Add make target to build source tarballs ([ipfs/go-ipfs#4920](https://github.com/glvd/starship/pull/4920))

- Improvements
  - Add BlockedFetched/Added/Removed events to Blockservice ([ipfs/go-ipfs#4649](https://github.com/glvd/starship/pull/4649))
  - Improve performance of HAMT code ([ipfs/go-ipfs#4889](https://github.com/glvd/starship/pull/4889))
  - Avoid unnecessarily resolving child nodes when listing a sharded directory ([ipfs/go-ipfs#4884](https://github.com/glvd/starship/pull/4884))
  - Tar writer now supports sharded ipfs directories ([ipfs/go-ipfs#4873](https://github.com/glvd/starship/pull/4873))
  - Infer type from CID when possible in `ipfs ls` ([ipfs/go-ipfs#4890](https://github.com/glvd/starship/pull/4890))
  - Deduplicate keys in GetMany ([ipfs/go-ipfs#4888](https://github.com/glvd/starship/pull/4888))

- Documentation
  - Fix spelling of retrieval ([ipfs/go-ipfs#4819](https://github.com/glvd/starship/pull/4819))
  - Update broken links ([ipfs/go-ipfs#4798](https://github.com/glvd/starship/pull/4798))
  - Remove roadmap.md ([ipfs/go-ipfs#4834](https://github.com/glvd/starship/pull/4834))
  - Remove link to IPFS paper in contribute.md ([ipfs/go-ipfs#4812](https://github.com/glvd/starship/pull/4812))
  - Fix broken todo link in readme.md ([ipfs/go-ipfs#4865](https://github.com/glvd/starship/pull/4865))
  - Document ipns pubsub ([ipfs/go-ipfs#4903](https://github.com/glvd/starship/pull/4903))
  - Fix missing profile docs ([ipfs/go-ipfs#4846](https://github.com/glvd/starship/pull/4846))
  - Fix a few typos ([ipfs/go-ipfs#4835](https://github.com/glvd/starship/pull/4835))
  - Fix typo in fsrepo error message ([ipfs/go-ipfs#4933](https://github.com/glvd/starship/pull/4933))
  - Remove go-ipfs version from issue template ([ipfs/go-ipfs#4943](https://github.com/glvd/starship/pull/4943))
  - Add docs for --profile=lowpower ([ipfs/go-ipfs#4970](https://github.com/glvd/starship/pull/4970))
  - Improve Windows build documentation ([ipfs/go-ipfs#4691](https://github.com/glvd/starship/pull/4691))

- Bugfixes
  - Check CIDs in base case when diffing nodes ([ipfs/go-ipfs#4767](https://github.com/glvd/starship/pull/4767))
  - Support for CIDv1 with custom mhtype in `ipfs block put` ([ipfs/go-ipfs#4563](https://github.com/glvd/starship/pull/4563))
  - Clean path in DagArchive ([ipfs/go-ipfs#4743](https://github.com/glvd/starship/pull/4743))
  - Set the prefix for MFS root in `ipfs add --hash-only` ([ipfs/go-ipfs#4755](https://github.com/glvd/starship/pull/4755))
  - Fix get output path ([ipfs/go-ipfs#4809](https://github.com/glvd/starship/pull/4809))
  - Fix incorrect Read calls ([ipfs/go-ipfs#4792](https://github.com/glvd/starship/pull/4792))
  - Use prefix in bootstrapWritePeers ([ipfs/go-ipfs#4832](https://github.com/glvd/starship/pull/4832))
  - Fix mfs Directory.Path not working ([ipfs/go-ipfs#4844](https://github.com/glvd/starship/pull/4844))
  - Remove header in `ipfs stats bw` if not polling ([ipfs/go-ipfs#4856](https://github.com/glvd/starship/pull/4856))
  - Match Go's GOPATH defaults behaviour in build scripts ([ipfs/go-ipfs#4678](https://github.com/glvd/starship/pull/4678))
  - Fix default-net profile not reverting bootstrap config ([ipfs/go-ipfs#4845](https://github.com/glvd/starship/pull/4845))
  - Fix excess goroutines in bitswap caused by insecure CIDs ([ipfs/go-ipfs#4946](https://github.com/glvd/starship/pull/4946))

- General Changes and Refactorings
  - Refactor trickle DAG builder ([ipfs/go-ipfs#4730](https://github.com/glvd/starship/pull/4730))
  - Split the coreapi interface into multiple files ([ipfs/go-ipfs#4802](https://github.com/glvd/starship/pull/4802))
  - Make `ipfs init` command use new cmds lib ([ipfs/go-ipfs#4732](https://github.com/glvd/starship/pull/4732))
  - Extract thirdparty/tar package ([ipfs/go-ipfs#4857](https://github.com/glvd/starship/pull/4857))
  - Reduce log level when for disconnected peers to info ([ipfs/go-ipfs#4811](https://github.com/glvd/starship/pull/4811))
  - Only visit nodes in EnumerateChildrenAsync when asked ([ipfs/go-ipfs#4885](https://github.com/glvd/starship/pull/4885))
  - Refactor coreapi options ([ipfs/go-ipfs#4807](https://github.com/glvd/starship/pull/4807))
  - Fix error style for most errors ([ipfs/go-ipfs#4829](https://github.com/glvd/starship/pull/4829))
  - Ensure `--help` always works, even with /dev/null stdin ([ipfs/go-ipfs#4849](https://github.com/glvd/starship/pull/4849))
  - Deduplicate AddNodeLinkClean into AddNodeLink ([ipfs/go-ipfs#4940](https://github.com/glvd/starship/pull/4940))
  - Remove some dead code ([ipfs/go-ipfs#4833](https://github.com/glvd/starship/pull/4833))
  - Remove unused imports ([ipfs/go-ipfs#4955](https://github.com/glvd/starship/pull/4955))
  - Fix go vet warnings ([ipfs/go-ipfs#4859](https://github.com/glvd/starship/pull/4859))

- Testing
  - Generate JUnit test reports for sharness tests ([ipfs/go-ipfs#4530](https://github.com/glvd/starship/pull/4530))
  - Fix t0063-daemon-init.sh by adding test profile to daemon ([ipfs/go-ipfs#4816](https://github.com/glvd/starship/pull/4816))
  - Remove circular dependencies in merkledag package tests ([ipfs/go-ipfs#4704](https://github.com/glvd/starship/pull/4704))
  - Check that all the commands fail when passed a bad flag ([ipfs/go-ipfs#4848](https://github.com/glvd/starship/pull/4848))
  - Allow for some small margin of code coverage dropping on commit ([ipfs/go-ipfs#4867](https://github.com/glvd/starship/pull/4867))
  - Add confirmation to archive-branches script ([ipfs/go-ipfs#4797](https://github.com/glvd/starship/pull/4797))

- Dependencies
  - Update lock package ([ipfs/go-ipfs#4855](https://github.com/glvd/starship/pull/4855))
  - Update to latest go-datastore. Remove thirdparty/datastore2 ([ipfs/go-ipfs#4742](https://github.com/glvd/starship/pull/4742))
  - Extract fs lock into go-fs-lock ([ipfs/go-ipfs#4631](https://github.com/glvd/starship/pull/4631))
  - Extract: exchange/interface.go, blocks/blocksutil, exchange/offline ([ipfs/go-ipfs#4912](https://github.com/glvd/starship/pull/4912))
  - Remove unused lock dep ([ipfs/go-ipfs#4971](https://github.com/glvd/starship/pull/4971))
  - Update iptb ([ipfs/go-ipfs#4965](https://github.com/glvd/starship/pull/4965))
  - Update go-ipfs-cmds to fix stdin on windows ([ipfs/go-ipfs#4975](https://github.com/glvd/starship/pull/4975))
  - Update go-ds-flatfs to fix windows corruption issue ([ipfs/go-ipfs#4872](https://github.com/glvd/starship/pull/4872))
...
- Fix bug in stdin argument parsing ([ipfs/go-ipfs#4827](https://github.com/glvd/starship/pull/4827))
- Revert commands back to sending a single response ([ipfs/go-ipfs#4822](https://github.com/glvd/starship/pull/4822))

#### Changes from rc1 to rc2
- Fix issue in ipfs get caused by go1.10 changes ([ipfs/go-ipfs#4790](https://github.com/glvd/starship/pull/4790))

- Features
  - Pubsub IPNS Publisher and Resolver (experimental) ([ipfs/go-ipfs#4047](https://github.com/glvd/starship/pull/4047))
  - Implement coreapi Dag interface ([ipfs/go-ipfs#4471](https://github.com/glvd/starship/pull/4471))
  - Add --offset flag to ipfs cat ([ipfs/go-ipfs#4538](https://github.com/glvd/starship/pull/4538))
  - Command to apply config profile after init ([ipfs/go-ipfs#4195](https://github.com/glvd/starship/pull/4195))
  - Implement coreapi Name and Key interfaces ([ipfs/go-ipfs#4477](https://github.com/glvd/starship/pull/4477))
  - Add --length flag to ipfs cat ([ipfs/go-ipfs#4553](https://github.com/glvd/starship/pull/4553))
  - Implement coreapi Object interface ([ipfs/go-ipfs#4492](https://github.com/glvd/starship/pull/4492))
  - Implement coreapi Block interface ([ipfs/go-ipfs#4548](https://github.com/glvd/starship/pull/4548))
  - Implement coreapi Pin interface ([ipfs/go-ipfs#4575](https://github.com/glvd/starship/pull/4575))
  - Add a --with-local flag to ipfs files stat ([ipfs/go-ipfs#4638](https://github.com/glvd/starship/pull/4638))
  - Disallow usage of blocks with insecure hashes ([ipfs/go-ipfs#4751](https://github.com/glvd/starship/pull/4751))
- Improvements
  - Add uuid to event logs ([ipfs/go-ipfs#4392](https://github.com/glvd/starship/pull/4392))
  - Add --quiet flag to object put ([ipfs/go-ipfs#4411](https://github.com/glvd/starship/pull/4411))
  - Pinning memory improvements and fixes ([ipfs/go-ipfs#4451](https://github.com/glvd/starship/pull/4451))
  - Update WebUI version ([ipfs/go-ipfs#4449](https://github.com/glvd/starship/pull/4449))
  - Check strong and weak ETag validator ([ipfs/go-ipfs#3983](https://github.com/glvd/starship/pull/3983))
  - Improve and refactor FD limit handling ([ipfs/go-ipfs#3801](https://github.com/glvd/starship/pull/3801))
  - Support linking to non-dagpb objects in ipfs object patch ([ipfs/go-ipfs#4460](https://github.com/glvd/starship/pull/4460))
  - Improve allocation patterns of slices in bitswap ([ipfs/go-ipfs#4458](https://github.com/glvd/starship/pull/4458))
  ...
  - Don't lock up 256KiB buffers when adding small files ([ipfs/go-ipfs#4508](https://github.com/glvd/starship/pull/4508))
  - Clear out memory after reads from the dagreader ([ipfs/go-ipfs#4525](https://github.com/glvd/starship/pull/4525))
  - Improve error handling in ipfs ping ([ipfs/go-ipfs#4546](https://github.com/glvd/starship/pull/4546))
  - Allow install.sh to be run without being the script dir ([ipfs/go-ipfs#4547](https://github.com/glvd/starship/pull/4547))
  ...
  - Wire up new dag interfaces to make sessions easier ([ipfs/go-ipfs#4641](https://github.com/glvd/starship/pull/4641))
- Documentation
  - Correct StorageMax config description ([ipfs/go-ipfs#4388](https://github.com/glvd/starship/pull/4388))
  - Add how to download IPFS with IPFS doc ([ipfs/go-ipfs#4390](https://github.com/glvd/starship/pull/4390))
  - Document gx release checklist item ([ipfs/go-ipfs#4480](https://github.com/glvd/starship/pull/4480))
  - Add some documentation to CoreAPI ([ipfs/go-ipfs#4493](https://github.com/glvd/starship/pull/4493))
  - Add interop tests to the release checklist ([ipfs/go-ipfs#4501](https://github.com/glvd/starship/pull/4501))
  - Add badgerds to experimental-features ToC ([ipfs/go-ipfs#4537](https://github.com/glvd/starship/pull/4537))
  - Fix typos and inconsistencies in commands documentation ([ipfs/go-ipfs#4552](https://github.com/glvd/starship/pull/4552))
  - Add a document to help troubleshoot data transfers ([ipfs/go-ipfs#4332](https://github.com/glvd/starship/pull/4332))
  - Add a bunch of documentation on public interfaces ([ipfs/go-ipfs#4599](https://github.com/glvd/starship/pull/4599))
  - Expand the issue template and remove the severity field ([ipfs/go-ipfs#4624](https://github.com/glvd/starship/pull/4624))
  - Add godocs for importers module ([ipfs/go-ipfs#4640](https://github.com/glvd/starship/pull/4640))
  - Document make targets ([ipfs/go-ipfs#4653](https://github.com/glvd/starship/pull/4653))
  - Add godocs for merkledag module ([ipfs/go-ipfs#4665](https://github.com/glvd/starship/pull/4665))
  - Add godocs for unixfs module ([ipfs/go-ipfs#4664](https://github.com/glvd/starship/pull/4664))
  - Add sharding to experimental features list ([ipfs/go-ipfs#4569](https://github.com/glvd/starship/pull/4569))
  - Add godocs for routing module ([ipfs/go-ipfs#4676](https://github.com/glvd/starship/pull/4676))
  - Add godocs for path module ([ipfs/go-ipfs#4689](https://github.com/glvd/starship/pull/4689))
  - Add godocs for pin module ([ipfs/go-ipfs#4696](https://github.com/glvd/starship/pull/4696))
  - Update link to filestore experimental status ([ipfs/go-ipfs#4557](https://github.com/glvd/starship/pull/4557))
- Bugfixes
  - Remove trailing slash in ipfs get paths, fixes #3729 ([ipfs/go-ipfs#4365](https://github.com/glvd/starship/pull/4365))
  - fix deadlock in bitswap sessions ([ipfs/go-ipfs#4407](https://github.com/glvd/starship/pull/4407))
  - Fix two race conditions (and possibly go routine leaks) in commands ([ipfs/go-ipfs#4406](https://github.com/glvd/starship/pull/4406))
  - Fix output delay in ipfs pubsub sub ([ipfs/go-ipfs#4402](https://github.com/glvd/starship/pull/4402))
  - Use correct context in AddWithContext ([ipfs/go-ipfs#4433](https://github.com/glvd/starship/pull/4433))
  - Fix various IPNS republisher issues ([ipfs/go-ipfs#4440](https://github.com/glvd/starship/pull/4440))
  - Fix error handling in commands add and get ([ipfs/go-ipfs#4454](https://github.com/glvd/starship/pull/4454))
  - Fix hamt (sharding) delete issue ([ipfs/go-ipfs#4398](https://github.com/glvd/starship/pull/4398))
  ...
  - Update badgerds to fix i386 windows build ([ipfs/go-ipfs#4464](https://github.com/glvd/starship/pull/4464))
  - Only construct bitswap event loggable if necessary ([ipfs/go-ipfs#4533](https://github.com/glvd/starship/pull/4533))
  - Ensure that flush on the mfs root flushes its directory ([ipfs/go-ipfs#4509](https://github.com/glvd/starship/pull/4509))
  - Fix deferred unlock of pin lock in AddR ([ipfs/go-ipfs#4562](https://github.com/glvd/starship/pull/4562))
  - Fix iOS builds ([ipfs/go-ipfs#4610](https://github.com/glvd/starship/pull/4610))
  - Calling repo gc now frees up space with badgerds ([ipfs/go-ipfs#4578](https://github.com/glvd/starship/pull/4578))
  - Fix leak in bitswap sessions shutdown ([ipfs/go-ipfs#4658](https://github.com/glvd/starship/pull/4658))
  - Fix make on windows ([ipfs/go-ipfs#4682](https://github.com/glvd/starship/pull/4682))
  - Ignore invalid key files in keystore directory ([ipfs/go-ipfs#4700](https://github.com/glvd/starship/pull/4700))
- General Changes and Refactorings
  - Extract and refactor commands library ([ipfs/go-ipfs#3856](https://github.com/glvd/starship/pull/3856))
  - Remove all instances of `Default(false)` ([ipfs/go-ipfs#4042](https://github.com/glvd/starship/pull/4042))
  - Build for all supported platforms when testing ([ipfs/go-ipfs#4445](https://github.com/glvd/starship/pull/4445))
  - Refine gateway and namesys logging ([ipfs/go-ipfs#4428](https://github.com/glvd/starship/pull/4428))
  - Demote bitswap error to an info ([ipfs/go-ipfs#4472](https://github.com/glvd/starship/pull/4472))
  - Extract posinfo package to github.com/ipfs/go-ipfs-posinfo ([ipfs/go-ipfs#4669](https://github.com/glvd/starship/pull/4669))
  - Move signature verification to ipns validator ([ipfs/go-ipfs#4628](https://github.com/glvd/starship/pull/4628))
  - Extract importers/chunk module as go-ipfs-chunker ([ipfs/go-ipfs#4661](https://github.com/glvd/starship/pull/4661))
  - Extract go-detect-race from Godeps ([ipfs/go-ipfs#4686](https://github.com/glvd/starship/pull/4686))
  - Extract flags, delay, ds-help ([ipfs/go-ipfs#4685](https://github.com/glvd/starship/pull/4685))
  - Extract routing package to go-ipfs-routing ([ipfs/go-ipfs#4703](https://github.com/glvd/starship/pull/4703))
  - Extract blocks/blockstore package to go-ipfs-blockstore ([ipfs/go-ipfs#4707](https://github.com/glvd/starship/pull/4707))
  - Add exchange.SessionExchange interface for exchanges that support sessions ([ipfs/go-ipfs#4709](https://github.com/glvd/starship/pull/4709))
  - Extract thirdparty/pq to go-ipfs-pq ([ipfs/go-ipfs#4711](https://github.com/glvd/starship/pull/4711))
  - Separate "path" from "path/resolver" ([ipfs/go-ipfs#4713](https://github.com/glvd/starship/pull/4713))
- Testing
  - Increase verbosity of t0088-repo-stat-symlink.sh test ([ipfs/go-ipfs#4434](https://github.com/glvd/starship/pull/4434))
  - Make repo size test pass deterministically ([ipfs/go-ipfs#4443](https://github.com/glvd/starship/pull/4443))
  - Always set IPFS_PATH in test-lib.sh ([ipfs/go-ipfs#4469](https://github.com/glvd/starship/pull/4469))
  - Fix sharness docker ([ipfs/go-ipfs#4489](https://github.com/glvd/starship/pull/4489))
  - Fix loops in sharness tests to fail the test if the inner command fails ([ipfs/go-ipfs#4482](https://github.com/glvd/starship/pull/4482))
  - Improve bitswap tests, fix race conditions ([ipfs/go-ipfs#4499](https://github.com/glvd/starship/pull/4499))
  - Fix circleci cache directory list ([ipfs/go-ipfs#4564](https://github.com/glvd/starship/pull/4564))
  - Only run the build test on test_go_expensive ([ipfs/go-ipfs#4645](https://github.com/glvd/starship/pull/4645))
  - Fix go test on Windows ([ipfs/go-ipfs#4632](https://github.com/glvd/starship/pull/4632))
  - Fix some tests on FreeBSD ([ipfs/go-ipfs#4662](https://github.com/glvd/starship/pull/4662))
...
Bugfixes:
  - Fix periodic bitswap deadlock ([ipfs/go-ipfs#4386](https://github.com/glvd/starship/pull/4386))
  - Fix badgerds crash on startup ([ipfs/go-ipfs#4384](https://github.com/glvd/starship/pull/4384))
...
[here](https://github.com/glvd/starship/blob/master/docs/config.md#connmgr) for
more details.
...
- Features
  - Implement Connection Manager ([ipfs/go-ipfs#4288](https://github.com/glvd/starship/pull/4288))
  - Support multiple files in dag put ([ipfs/go-ipfs#4254](https://github.com/glvd/starship/pull/4254))
  - Add 'raw' support to the dag put command ([ipfs/go-ipfs#4285](https://github.com/glvd/starship/pull/4285))
- Improvements
  - Parallelize dag batch flushing ([ipfs/go-ipfs#4296](https://github.com/glvd/starship/pull/4296))
  - Update go-peerstream to improve CPU usage ([ipfs/go-ipfs#4323](https://github.com/glvd/starship/pull/4323))
  - Add full support for CidV1 in Files API and Dag Modifier ([ipfs/go-ipfs#4026](https://github.com/glvd/starship/pull/4026))
  - Lower yamux accept buffer size ([ipfs/go-ipfs#4326](https://github.com/glvd/starship/pull/4326))
  - Optimise `ipfs pin update` command ([ipfs/go-ipfs#4348](https://github.com/glvd/starship/pull/4348))
- Documentation
  - Add some docs on plugins ([ipfs/go-ipfs#4255](https://github.com/glvd/starship/pull/4255))
  - Add more info about private network bootstrap ([ipfs/go-ipfs#4270](https://github.com/glvd/starship/pull/4270))
  - Add more info about `ipfs add` chunker option ([ipfs/go-ipfs#4306](https://github.com/glvd/starship/pull/4306))
  - Remove cruft in readme and mention discourse forum ([ipfs/go-ipfs#4345](https://github.com/glvd/starship/pull/4345))
  - Add note about updating before reporting issues ([ipfs/go-ipfs#4361](https://github.com/glvd/starship/pull/4361))
- Bugfixes
  - Fix FreeBSD build issues ([ipfs/go-ipfs#4275](https://github.com/glvd/starship/pull/4275))
  - Don't crash when Datastore.StorageMax is not defined ([ipfs/go-ipfs#4246](https://github.com/glvd/starship/pull/4246))
  - Do not call 'Connect' on NewStream in bitswap ([ipfs/go-ipfs#4317](https://github.com/glvd/starship/pull/4317))
  - Filter out "" from active peers in bitswap sessions ([ipfs/go-ipfs#4316](https://github.com/glvd/starship/pull/4316))
  - Fix "seeker can't seek" on specific files ([ipfs/go-ipfs#4320](https://github.com/glvd/starship/pull/4320))
  - Do not set "gecos" field in Dockerfile ([ipfs/go-ipfs#4331](https://github.com/glvd/starship/pull/4331))
  - Handle sym links in when calculating repo size ([ipfs/go-ipfs#4305](https://github.com/glvd/starship/pull/4305))
- General Changes and Refactorings
  - Fix indent in sharness tests ([ipfs/go-ipfs#4212](https://github.com/glvd/starship/pull/4212))
  - Remove supernode routing ([ipfs/go-ipfs#4302](https://github.com/glvd/starship/pull/4302))
  - Extract go-ipfs-addr ([ipfs/go-ipfs#4340](https://github.com/glvd/starship/pull/4340))
  - Remove dead code and config files ([ipfs/go-ipfs#4357](https://github.com/glvd/starship/pull/4357))
  - Update badgerds to 1.0 ([ipfs/go-ipfs#4327](https://github.com/glvd/starship/pull/4327))
  - Wrap help descriptions under 80 chars ([ipfs/go-ipfs#4121](https://github.com/glvd/starship/pull/4121))
- Testing
  - Make sharness t0180-p2p less racy ([ipfs/go-ipfs#4310](https://github.com/glvd/starship/pull/4310))
...
documentation](https://github.com/glvd/starship/blob/master/docs/datastores.md)
...
[here](https://github.com/glvd/starship/blob/master/docs/experimental-features.md#circuit-relay).
...
plugin](https://github.com/glvd/starship/blob/master/plugin/plugins/git/git.go)
...
- Features
  - Add `--pin` option to `ipfs dag put` ([ipfs/go-ipfs#4004](https://github.com/glvd/starship/pull/4004))
  - Add `--pin` option to `ipfs object put` ([ipfs/go-ipfs#4095](https://github.com/glvd/starship/pull/4095))
  - Implement `--profile` option on `ipfs init` ([ipfs/go-ipfs#4001](https://github.com/glvd/starship/pull/4001))
  - Add CID Codecs to `ipfs block put` ([ipfs/go-ipfs#4022](https://github.com/glvd/starship/pull/4022))
  - Bitswap sessions ([ipfs/go-ipfs#3867](https://github.com/glvd/starship/pull/3867))
  - Create plugin API and loader, add ipld-git plugin ([ipfs/go-ipfs#4033](https://github.com/glvd/starship/pull/4033))
  - Make announced swarm addresses configurable ([ipfs/go-ipfs#3948](https://github.com/glvd/starship/pull/3948))
  - Reprovider strategies ([ipfs/go-ipfs#4113](https://github.com/glvd/starship/pull/4113))
  - Circuit Relay integration ([ipfs/go-ipfs#4091](https://github.com/glvd/starship/pull/4091))
  - More configurable datastore configs ([ipfs/go-ipfs#3575](https://github.com/glvd/starship/pull/3575))
  - Add experimental support for badger datastore ([ipfs/go-ipfs#4007](https://github.com/glvd/starship/pull/4007))
- Improvements
  - Add better support for Raw Nodes in MFS and elsewhere ([ipfs/go-ipfs#3996](https://github.com/glvd/starship/pull/3996))
  - Added file size to response of `ipfs add` command ([ipfs/go-ipfs#4082](https://github.com/glvd/starship/pull/4082))
  - Add /dnsaddr bootstrap nodes ([ipfs/go-ipfs#4127](https://github.com/glvd/starship/pull/4127))
  - Do not publish public keys extractable from ID ([ipfs/go-ipfs#4020](https://github.com/glvd/starship/pull/4020))
- Documentation
  - Adding documentation that PubSub Sub can be encoded. ([ipfs/go-ipfs#3909](https://github.com/glvd/starship/pull/3909))
  - Add Comms items from js-ipfs, including blog ([ipfs/go-ipfs#3936](https://github.com/glvd/starship/pull/3936))
  - Add Developer Certificate of Origin ([ipfs/go-ipfs#4006](https://github.com/glvd/starship/pull/4006))
  - Add `transports.md` document ([ipfs/go-ipfs#4034](https://github.com/glvd/starship/pull/4034))
  - Add `experimental-features.md` document ([ipfs/go-ipfs#4036](https://github.com/glvd/starship/pull/4036))
  - Update release docs ([ipfs/go-ipfs#4165](https://github.com/glvd/starship/pull/4165))
  - Add documentation for datastore configs ([ipfs/go-ipfs#4223](https://github.com/glvd/starship/pull/4223))
  - General update and clean-up of docs ([ipfs/go-ipfs#4222](https://github.com/glvd/starship/pull/4222))
- Bugfixes
  - Fix shutdown check in t0023 ([ipfs/go-ipfs#3969](https://github.com/glvd/starship/pull/3969))
  - Fix pinning of unixfs sharded directories ([ipfs/go-ipfs#3975](https://github.com/glvd/starship/pull/3975))
  - Show escaped url in gateway 404 message ([ipfs/go-ipfs#4005](https://github.com/glvd/starship/pull/4005))
  - Fix early opening of bitswap message sender ([ipfs/go-ipfs#4069](https://github.com/glvd/starship/pull/4069))
  - Fix determination of 'root' node in dag put ([ipfs/go-ipfs#4072](https://github.com/glvd/starship/pull/4072))
  - Fix bad multipart message panic in gateway ([ipfs/go-ipfs#4053](https://github.com/glvd/starship/pull/4053))
  - Add blocks to the blockstore before returning them from blockservice sessions ([ipfs/go-ipfs#4169](https://github.com/glvd/starship/pull/4169))
  - Various fixes for /ipfs fuse code ([ipfs/go-ipfs#4194](https://github.com/glvd/starship/pull/4194))
  - Fix memory leak in dht stream tracking ([ipfs/go-ipfs#4251](https://github.com/glvd/starship/pull/4251))
- General Changes and Refactorings
  - Require go 1.8 ([ipfs/go-ipfs#4044](https://github.com/glvd/starship/pull/4044))
  - Change IPFS to use the new pluggable Block to IPLD decoding framework. ([ipfs/go-ipfs#4060](https://github.com/glvd/starship/pull/4060))
  - Remove tour command from ipfs ([ipfs/go-ipfs#4123](https://github.com/glvd/starship/pull/4123))
  - Add support for Go 1.9 ([ipfs/go-ipfs#4156](https://github.com/glvd/starship/pull/4156))
  - Remove some dead code ([ipfs/go-ipfs#4204](https://github.com/glvd/starship/pull/4204))
  - Switch docker image from musl to glibc ([ipfs/go-ipfs#4219](https://github.com/glvd/starship/pull/4219))
...
issue](https://github.com/glvd/starship/issues/3994) for the command.
...
- Features
  - Add support for specifying the hash function in `ipfs add` ([ipfs/go-ipfs#3919](https://github.com/glvd/starship/pull/3919))
  - Implement `ipfs key {rm, rename}` ([ipfs/go-ipfs#3892](https://github.com/glvd/starship/pull/3892))
  - Implement `ipfs shutdown` command ([ipfs/go-ipfs#3884](https://github.com/glvd/starship/pull/3884))
  - Implement `ipfs pin update` ([ipfs/go-ipfs#3846](https://github.com/glvd/starship/pull/3846))
  - Implement `ipfs pin verify` ([ipfs/go-ipfs#3843](https://github.com/glvd/starship/pull/3843))
  - Implemented experimental p2p commands ([ipfs/go-ipfs#3943](https://github.com/glvd/starship/pull/3943))
- Improvements
  - Add MaxStorage field to output of "repo stat" ([ipfs/go-ipfs#3915](https://github.com/glvd/starship/pull/3915))
  - Add Suborigin header to gateway responses ([ipfs/go-ipfs#3914](https://github.com/glvd/starship/pull/3914))
  - Add "--file-order" option to "filestore ls" and "verify" ([ipfs/go-ipfs#3938](https://github.com/glvd/starship/pull/3938))
  - Allow selecting ipns keys by Peer ID ([ipfs/go-ipfs#3882](https://github.com/glvd/starship/pull/3882))
  - Don't redirect to trailing slash in gateway for `go get` ([ipfs/go-ipfs#3963](https://github.com/glvd/starship/pull/3963))
  - Add 'ipfs dht findprovs --num-providers' to allow choosing number of providers to find ([ipfs/go-ipfs#3966](https://github.com/glvd/starship/pull/3966))
  - Make sure all keystore keys get republished ([ipfs/go-ipfs#3951](https://github.com/glvd/starship/pull/3951))
- Documentation
  - Adding documentation on PubSub encodings ([ipfs/go-ipfs#3909](https://github.com/glvd/starship/pull/3909))
  - Change 'neccessary' to 'necessary' ([ipfs/go-ipfs#3941](https://github.com/glvd/starship/pull/3941))
  - README.md: add Nix to the linux package managers ([ipfs/go-ipfs#3939](https://github.com/glvd/starship/pull/3939))
  - More verbose errors in filestore ([ipfs/go-ipfs#3964](https://github.com/glvd/starship/pull/3964))
- Bugfixes
  - Fix typo in message when file size check fails ([ipfs/go-ipfs#3895](https://github.com/glvd/starship/pull/3895))
  - Clean up bitswap ledgers when disconnecting ([ipfs/go-ipfs#3437](https://github.com/glvd/starship/pull/3437))
  - Make odds of 'process added after close' panic less likely ([ipfs/go-ipfs#3940](https://github.com/glvd/starship/pull/3940))
- General Changes and Refactorings
  - Remove 'ipfs diag net' from codebase ([ipfs/go-ipfs#3916](https://github.com/glvd/starship/pull/3916))
  - Update to dht code with provide announce option ([ipfs/go-ipfs#3928](https://github.com/glvd/starship/pull/3928))
  - Apply the megacheck code vetting tool ([ipfs/go-ipfs#3949](https://github.com/glvd/starship/pull/3949))
  - Expose port 8081 in docker container for /ws listener ([ipfs/go-ipfs#3954](https://github.com/glvd/starship/pull/3954))
...
- Features
  - Add support for using CidV1 in 'ipfs add' ([ipfs/go-ipfs#3743](https://github.com/glvd/starship/pull/3743))
- Improvements
  - Use CID as an ETag strong validator ([ipfs/go-ipfs#3869](https://github.com/glvd/starship/pull/3869))
  - Update go-multihash with keccak and bitcoin hashes ([ipfs/go-ipfs#3833](https://github.com/glvd/starship/pull/3833))
  - Update go-is-domain to contain new gTLD ([ipfs/go-ipfs#3873](https://github.com/glvd/starship/pull/3873))
  - Periodically flush cached directories during ipfs add ([ipfs/go-ipfs#3888](https://github.com/glvd/starship/pull/3888))
  - improved gateway directory listing for sharded nodes ([ipfs/go-ipfs#3897](https://github.com/glvd/starship/pull/3897))
- Documentation
  - Change issue template to use Severity instead of Priority ([ipfs/go-ipfs#3834](https://github.com/glvd/starship/pull/3834))
  - Fix link to commit hook script in contribute.md ([ipfs/go-ipfs#3863](https://github.com/glvd/starship/pull/3863))
  - Fix install_unsupported for openbsd, add docs ([ipfs/go-ipfs#3880](https://github.com/glvd/starship/pull/3880))
- Bugfixes
  - Fix wanlist typo in prometheus metric name ([ipfs/go-ipfs#3841](https://github.com/glvd/starship/pull/3841))
  - Fix `make install` not using ldflags for git hash ([ipfs/go-ipfs#3838](https://github.com/glvd/starship/pull/3838))
  - Fix `make install` not installing dependencies ([ipfs/go-ipfs#3848](https://github.com/glvd/starship/pull/3848))
  - Fix erroneous Cache-Control: immutable on dir listings ([ipfs/go-ipfs#3870](https://github.com/glvd/starship/pull/3870))
  - Fix bitswap accounting of 'BytesSent' in ledger ([ipfs/go-ipfs#3876](https://github.com/glvd/starship/pull/3876))
  - Fix gateway handling of sharded directories ([ipfs/go-ipfs#3889](https://github.com/glvd/starship/pull/3889))
  - Fix sharding memory growth, and fix resolver for unixfs paths ([ipfs/go-ipfs#3890](https://github.com/glvd/starship/pull/3890))
- General Changes and Refactorings
  - Use ctx var consistently in daemon.go ([ipfs/go-ipfs#3864](https://github.com/glvd/starship/pull/3864))
  - Handle 404 correctly in dist_get tool ([ipfs/go-ipfs#3879](https://github.com/glvd/starship/pull/3879))
- Testing
  - Fix go fuse tests ([ipfs/go-ipfs#3840](https://github.com/glvd/starship/pull/3840))
...
- Features
	- Implement unixfs directory sharding ([ipfs/go-ipfs#3042](https://github.com/glvd/starship/pull/3042))
	- Add DisableNatPortMap option ([ipfs/go-ipfs#3798](https://github.com/glvd/starship/pull/3798))
	- Basic Filestore utilty commands ([ipfs/go-ipfs#3653](https://github.com/glvd/starship/pull/3653))
- Improvements
	- More Robust GC ([ipfs/go-ipfs#3712](https://github.com/glvd/starship/pull/3712))
	- Automatically fix permissions for docker volumes ([ipfs/go-ipfs#3744](https://github.com/glvd/starship/pull/3744))
	- Core API refinements and efficiency improvements ([ipfs/go-ipfs#3493](https://github.com/glvd/starship/pull/3493))
	- Improve IsPinned() lookups for indirect pins ([ipfs/go-ipfs#3809](https://github.com/glvd/starship/pull/3809))
- Documentation
	- Improve 'name' and 'key' helptexts ([ipfs/go-ipfs#3806](https://github.com/glvd/starship/pull/3806))
	- Update link to paper in dev.md ([ipfs/go-ipfs#3812](https://github.com/glvd/starship/pull/3812))
	- Add test to enforce helptext on commands ([ipfs/go-ipfs#2648](https://github.com/glvd/starship/pull/2648))
- Bugfixes
	- Remove bloom filter check on Put call in blockstore ([ipfs/go-ipfs#3782](https://github.com/glvd/starship/pull/3782))
	- Re-add the GOPATH checking functionality ([ipfs/go-ipfs#3787](https://github.com/glvd/starship/pull/3787))
	- Use fsrepo.IsInitialized to test for initialization ([ipfs/go-ipfs#3805](https://github.com/glvd/starship/pull/3805))
	- Return 404 Not Found for failed path resolutions ([ipfs/go-ipfs#3777](https://github.com/glvd/starship/pull/3777))
	- Fix 'dist\_get' failing without failing ([ipfs/go-ipfs#3818](https://github.com/glvd/starship/pull/3818))
	- Update iptb with fix for t0130 hanging issue ([ipfs/go-ipfs#3823](https://github.com/glvd/starship/pull/3823))
	- fix hidden file detection on windows ([ipfs/go-ipfs#3829](https://github.com/glvd/starship/pull/3829))
- General Changes and Refactorings
	- Fix multiple govet warnings ([ipfs/go-ipfs#3824](https://github.com/glvd/starship/pull/3824))
	- Make Golint happy in the blocks submodule ([ipfs/go-ipfs#3827](https://github.com/glvd/starship/pull/3827))
- Testing
	- Enable codeclimate for automated linting and vetting ([ipfs/go-ipfs#3821](https://github.com/glvd/starship/pull/3821))
	- Fix EOF test failure with Multipart.Read ([ipfs/go-ipfs#3804](https://github.com/glvd/starship/pull/3804))
...
```
before it can be used. Please see [this issue](https://github.com/glvd/starship/issues/3397#issuecomment-284337564) for more details.
...
[here](https://github.com/glvd/starship/issues/3397#issuecomment-284341649).
...
- Features
	- Implement basic filestore 'no-copy' functionality ([ipfs/go-ipfs#3629](https://github.com/glvd/starship/pull/3629))
	- Add support for private ipfs networks ([ipfs/go-ipfs#3697](https://github.com/glvd/starship/pull/3697))
	- Enable 'mplex' stream muxer by default ([ipfs/go-ipfs#3725](https://github.com/glvd/starship/pull/3725))
	- Add `--quieter` option to `ipfs add` ([ipfs/go-ipfs#3770](https://github.com/glvd/starship/pull/3770))
	- Report progress during `pin add` via `--progress` ([ipfs/go-ipfs#3671](https://github.com/glvd/starship/pull/3671))
- Improvements
	- Allow `ipfs get` to handle content added with raw leaves option ([ipfs/go-ipfs#3757](https://github.com/glvd/starship/pull/3757))
	- Fix accuracy of progress bar on `ipfs get` ([ipfs/go-ipfs#3758](https://github.com/glvd/starship/pull/3758))
	- Limit number of objects in batches to prevent too many fds issue ([ipfs/go-ipfs#3756](https://github.com/glvd/starship/pull/3756))
	- Add more info to bitswap stat ([ipfs/go-ipfs#3635](https://github.com/glvd/starship/pull/3635))
	- Add multiple performance metrics ([ipfs/go-ipfs#3615](https://github.com/glvd/starship/pull/3615))
	- Make `dist_get` fall back to other downloaders if one fails ([ipfs/go-ipfs#3692](https://github.com/glvd/starship/pull/3692))
- Documentation
	- Add Arch Linux install instructions to readme ([ipfs/go-ipfs#3742](https://github.com/glvd/starship/pull/3742))
	- Improve release checklist document ([ipfs/go-ipfs#3717](https://github.com/glvd/starship/pull/3717))
- Bugfixes
	- Fix drive root parsing on windows ([ipfs/go-ipfs#3328](https://github.com/glvd/starship/pull/3328))
	- Fix panic in ipfs get when passing no parameters to API ([ipfs/go-ipfs#3768](https://github.com/glvd/starship/pull/3768))
	- Fix breakage of `ipfs pin add` api output ([ipfs/go-ipfs#3760](https://github.com/glvd/starship/pull/3760))
	- Fix issue in DHT queries that was causing poor record replication ([ipfs/go-ipfs#3748](https://github.com/glvd/starship/pull/3748))
	- Fix `ipfs mount` crashing if no name was published before ([ipfs/go-ipfs#3728](https://github.com/glvd/starship/pull/3728))
	- Add `self` key to the `ipfs key list` listing ([ipfs/go-ipfs#3734](https://github.com/glvd/starship/pull/3734))
	- Fix panic when shutting down `ipfs daemon` pre gateway setup ([ipfs/go-ipfs#3723](https://github.com/glvd/starship/pull/3723))
- General Changes and Refactorings
	- Refactor `EnumerateChildren` to avoid need for bestEffort parameter ([ipfs/go-ipfs#3700](https://github.com/glvd/starship/pull/3700))
	- Update fuse dependency, fixing several issues ([ipfs/go-ipfs#3727](https://github.com/glvd/starship/pull/3727))
	- Add `install_unsupported` makefile target for 'exotic' systems ([ipfs/go-ipfs#3719](https://github.com/glvd/starship/pull/3719))
	- Deprecate implicit daemon argument in Dockerfile ([ipfs/go-ipfs#3685](https://github.com/glvd/starship/pull/3685))
- Testing
	- Add test to ensure helptext is under 80 columns wide ([ipfs/go-ipfs#3774](https://github.com/glvd/starship/pull/3774))
	- Add unit tests for auto migration code ([ipfs/go-ipfs#3618](https://github.com/glvd/starship/pull/3618))
	- Fix iptb stop issue in sharness tests  ([ipfs/go-ipfs#3714](https://github.com/glvd/starship/pull/3714))
...
- Improvements
	- Make pinset sharding deterministic ([ipfs/go-ipfs#3640](https://github.com/glvd/starship/pull/3640))
	- Update to go-multihash with blake2 ([ipfs/go-ipfs#3649](https://github.com/glvd/starship/pull/3649))
	- Pass cids instead of nodes around in EnumerateChildrenAsync ([ipfs/go-ipfs#3598](https://github.com/glvd/starship/pull/3598))
	- Add /ip6 bootstrap nodes ([ipfs/go-ipfs#3523](https://github.com/glvd/starship/pull/3523))
	- Add sub-object support to `dag get` command ([ipfs/go-ipfs#3687](https://github.com/glvd/starship/pull/3687))
	- Add half-closed streams support to multiplex experiment ([ipfs/go-ipfs#3695](https://github.com/glvd/starship/pull/3695))
- Documentation
	- Add the snap installation instructions ([ipfs/go-ipfs#3663](https://github.com/glvd/starship/pull/3663))
	- Add closed PRs, Issues throughput ([ipfs/go-ipfs#3602](https://github.com/glvd/starship/pull/3602))
- Bugfixes
	- Fix auto-migration on docker nodes ([ipfs/go-ipfs#3698](https://github.com/glvd/starship/pull/3698))
	- Update flatfs to v1.1.2, fixing directory fd issue ([ipfs/go-ipfs#3711](https://github.com/glvd/starship/pull/3711))
- General Changes and Refactorings
	- Remove `FindProviders` from routing mocks ([ipfs/go-ipfs#3617](https://github.com/glvd/starship/pull/3617))
	- Use Marshalers instead of PostRun to process `block rm` output ([ipfs/go-ipfs#3708](https://github.com/glvd/starship/pull/3708))
- Testing
	- Makefile rework and sharness test coverage ([ipfs/go-ipfs#3504](https://github.com/glvd/starship/pull/3504))
	- Print out all daemon stderr files when iptb stop fails ([ipfs/go-ipfs#3701](https://github.com/glvd/starship/pull/3701))
	- Add tests for recursively pinning a dag ([ipfs/go-ipfs#3691](https://github.com/glvd/starship/pull/3691))
	- Fix lack of commit hash during build ([ipfs/go-ipfs#3705](https://github.com/glvd/starship/pull/3705))

### 0.4.5 - 2017-02-11

#### Changes from rc3 to rc4
- Update to fixed webui. ([ipfs/go-ipfs#3669](https://github.com/glvd/starship/pull/3669))

#### Changes from rc2 to rc3
- Fix handling of null arrays in cbor ipld objects.  ([ipfs/go-ipfs#3666](https://github.com/glvd/starship/pull/3666))
- Add env var to enable yamux debug logging.  ([ipfs/go-ipfs#3668](https://github.com/glvd/starship/pull/3668))
- Fix libc check during auto-migrations.  ([ipfs/go-ipfs#3665](https://github.com/glvd/starship/pull/3665))

#### Changes from rc1 to rc2
- Fixed json output of ipld objects in `ipfs dag get` ([ipfs/go-ipfs#3655](https://github.com/glvd/starship/pull/3655))

#### Changes since 0.4.4

- Notable changes
	- IPLD and CIDs
	  - Rework go-ipfs to use Content IDs  ([ipfs/go-ipfs#3187](https://github.com/glvd/starship/pull/3187))  ([ipfs/go-ipfs#3290](https://github.com/glvd/starship/pull/3290))
	  - Turn merkledag.Node into an interface ([ipfs/go-ipfs#3301](https://github.com/glvd/starship/pull/3301))
	  - Implement cbor ipld nodes  ([ipfs/go-ipfs#3325](https://github.com/glvd/starship/pull/3325))
	  - Allow cid format selection in block put command  ([ipfs/go-ipfs#3324](https://github.com/glvd/starship/pull/3324))  ([ipfs/go-ipfs#3483](https://github.com/glvd/starship/pull/3483))
	  - Bitswap protocol extension to handle cids  ([ipfs/go-ipfs#3297](https://github.com/glvd/starship/pull/3297))
	  - Add dag get to read-only api  ([ipfs/go-ipfs#3499](https://github.com/glvd/starship/pull/3499))
	- Raw Nodes
	  - Implement 'Raw Node' node type for addressing raw data  ([ipfs/go-ipfs#3307](https://github.com/glvd/starship/pull/3307))
	  - Optimize DagService GetLinks for Raw Nodes.  ([ipfs/go-ipfs#3351](https://github.com/glvd/starship/pull/3351))
	- Experimental PubSub
	  - Added a very basic pubsub implementation  ([ipfs/go-ipfs#3202](https://github.com/glvd/starship/pull/3202))
	- Core API
	  - gateway: use core api for serving GET/HEAD/POST  ([ipfs/go-ipfs#3244](https://github.com/glvd/starship/pull/3244))

- Improvements
	- Disable auto-gc check in 'ipfs cat'  ([ipfs/go-ipfs#3100](https://github.com/glvd/starship/pull/3100))
	- Add `bitswap ledger` command  ([ipfs/go-ipfs#2852](https://github.com/glvd/starship/pull/2852))
	- Add `ipfs block rm` command.  ([ipfs/go-ipfs#2962](https://github.com/glvd/starship/pull/2962))
	- Add config option to disable bandwidth metrics   ([ipfs/go-ipfs#3381](https://github.com/glvd/starship/pull/3381))
	- Add experimental dht 'client mode' flag  ([ipfs/go-ipfs#3269](https://github.com/glvd/starship/pull/3269))
	- Add config option to set reprovider interval  ([ipfs/go-ipfs#3101](https://github.com/glvd/starship/pull/3101))
	- Add `ipfs dht provide` command  ([ipfs/go-ipfs#3106](https://github.com/glvd/starship/pull/3106))
	- Add stream info to `ipfs swarm peers -v`  ([ipfs/go-ipfs#3352](https://github.com/glvd/starship/pull/3352))
	- Add option to enable go-multiplex experiment  ([ipfs/go-ipfs#3447](https://github.com/glvd/starship/pull/3447))
	- Basic Keystore implementation  ([ipfs/go-ipfs#3472](https://github.com/glvd/starship/pull/3472))
	- Make `ipfs add --local` not send providers messages  ([ipfs/go-ipfs#3102](https://github.com/glvd/starship/pull/3102))
	- Fix bug in `ipfs tar add` that buffered input in memory  ([ipfs/go-ipfs#3334](https://github.com/glvd/starship/pull/3334))
	- Make blockstore retry operations on temporary errors  ([ipfs/go-ipfs#3091](https://github.com/glvd/starship/pull/3091))
	- Don't hold the PinLock in adder when not pinning.  ([ipfs/go-ipfs#3222](https://github.com/glvd/starship/pull/3222))
	- Validate repo/api file and improve error message  ([ipfs/go-ipfs#3219](https://github.com/glvd/starship/pull/3219))
	- no longer hard code gomaxprocs  ([ipfs/go-ipfs#3357](https://github.com/glvd/starship/pull/3357))
	- Updated Bash complete script  ([ipfs/go-ipfs#3377](https://github.com/glvd/starship/pull/3377))
	- Remove expensive debug statement in blockstore AllKeysChan  ([ipfs/go-ipfs#3384](https://github.com/glvd/starship/pull/3384))
	- Remove GC timeout, fix GC tests  ([ipfs/go-ipfs#3494](https://github.com/glvd/starship/pull/3494))
	- Fix `ipfs pin add` resource consumption  ([ipfs/go-ipfs#3495](https://github.com/glvd/starship/pull/3495))  ([ipfs/go-ipfs#3571](https://github.com/glvd/starship/pull/3571))
	- Add IPNS entry to DHT cache after publish  ([ipfs/go-ipfs#3501](https://github.com/glvd/starship/pull/3501))
	- Add in `--routing=none` daemon option  ([ipfs/go-ipfs#3605](https://github.com/glvd/starship/pull/3605))

- Bitswap
	- Don't re-provide blocks we've provided very recently  ([ipfs/go-ipfs#3105](https://github.com/glvd/starship/pull/3105))
	- Add a deadline to sendmsg calls ([ipfs/go-ipfs#3445](https://github.com/glvd/starship/pull/3445))
	- cleanup bitswap and handle message send failure slightly better  ([ipfs/go-ipfs#3408](https://github.com/glvd/starship/pull/3408))
	- Increase wantlist resend delay to one minute  ([ipfs/go-ipfs#3448](https://github.com/glvd/starship/pull/3448))
	- Fix issue where wantlist fullness wasn't included in messages  ([ipfs/go-ipfs#3461](https://github.com/glvd/starship/pull/3461))
	- Only pass keys down newBlocks chan in bitswap   ([ipfs/go-ipfs#3271](https://github.com/glvd/starship/pull/3271))

- Bugfixes
	- gateway: fix --writable flag  ([ipfs/go-ipfs#3206](https://github.com/glvd/starship/pull/3206))
	- Fix relative seek in unixfs not expanding file properly   ([ipfs/go-ipfs#3095](https://github.com/glvd/starship/pull/3095))
	- Update multicodec service names for ipfs services  ([ipfs/go-ipfs#3132](https://github.com/glvd/starship/pull/3132))
	- dht: add missing protocol ID to newStream call  ([ipfs/go-ipfs#3203](https://github.com/glvd/starship/pull/3203))
	- Return immediately on namesys error  ([ipfs/go-ipfs#3345](https://github.com/glvd/starship/pull/3345))
	- Improve osxfuse handling  ([ipfs/go-ipfs#3098](https://github.com/glvd/starship/pull/3098))  ([ipfs/go-ipfs#3413](https://github.com/glvd/starship/pull/3413))
	- commands: fix opt.Description panic when desc was empty  ([ipfs/go-ipfs#3521](https://github.com/glvd/starship/pull/3521))
	- Fixes #3133: Properly handle release candidates in version comparison  ([ipfs/go-ipfs#3136](https://github.com/glvd/starship/pull/3136))
	- Don't drop error in readStreamedJson.  ([ipfs/go-ipfs#3276](https://github.com/glvd/starship/pull/3276))
	- Error out on invalid `--routing` option  ([ipfs/go-ipfs#3482](https://github.com/glvd/starship/pull/3482))
	- Respect contexts when returning diagnostics responses  ([ipfs/go-ipfs#3353](https://github.com/glvd/starship/pull/3353))
	- Fix json marshalling of pbnode  ([ipfs/go-ipfs#3507](https://github.com/glvd/starship/pull/3507))

- General changes and refactorings
	- Disable Suborigins the spec changed and our impl conflicts  ([ipfs/go-ipfs#3519](https://github.com/glvd/starship/pull/3519))
	- Avoid sending provide messages for pinsets  ([ipfs/go-ipfs#3103](https://github.com/glvd/starship/pull/3103))
	- Refactor cli handling to expose argument parsing functionality  ([ipfs/go-ipfs#3308](https://github.com/glvd/starship/pull/3308))
	- Create a FilestoreNode object to carry PosInfo  ([ipfs/go-ipfs#3314](https://github.com/glvd/starship/pull/3314))
	- Print 'n/a' instead of zero latency in `ipfs swarm peers`  ([ipfs/go-ipfs#3491](https://github.com/glvd/starship/pull/3491))
	- Add DAGService.GetLinks() method to optimize traversals.  ([ipfs/go-ipfs#3255](https://github.com/glvd/starship/pull/3255))
	- Make path resolver no longer require whole IpfsNode for construction  ([ipfs/go-ipfs#3321](https://github.com/glvd/starship/pull/3321))
	- Distinguish between Offline and Local Modes of daemon operation.  ([ipfs/go-ipfs#3259](https://github.com/glvd/starship/pull/3259))
	- Separate out the GC Locking from the Blockstore interface.  ([ipfs/go-ipfs#3348](https://github.com/glvd/starship/pull/3348))
	- Avoid unnecessary allocs in datastore key handling  ([ipfs/go-ipfs#3407](https://github.com/glvd/starship/pull/3407))
	- Use NextSync method for datastore queries ([ipfs/go-ipfs#3386](https://github.com/glvd/starship/pull/3386))
	- Switch unixfs.Metadata.MimeType to optional ([ipfs/go-ipfs#3458](https://github.com/glvd/starship/pull/3458))
	- Fix path parsing in `ipfs name publish`   ([ipfs/go-ipfs#3592](https://github.com/glvd/starship/pull/3592))
	- Fix inconsistent `ipfs stats bw` formatting  ([ipfs/go-ipfs#3554](https://github.com/glvd/starship/pull/3554))
	- Set the libp2p agent version based on version string  ([ipfs/go-ipfs#3569](https://github.com/glvd/starship/pull/3569))

- Cross Platform Changes
	- Fix 'dist_get' script on BSDs.  ([ipfs/go-ipfs#3264](https://github.com/glvd/starship/pull/3264))
	- ulimit: Tune resource limits on BSDs  ([ipfs/go-ipfs#3374](https://github.com/glvd/starship/pull/3374))

- Metrics
	- Introduce go-metrics-interface  ([ipfs/go-ipfs#3189](https://github.com/glvd/starship/pull/3189))
	- Fix metrics injection  ([ipfs/go-ipfs#3315](https://github.com/glvd/starship/pull/3315))

- Misc
	- Bump Go requirement to 1.7  ([ipfs/go-ipfs#3111](https://github.com/glvd/starship/pull/3111))
	- Merge 0.4.3 release candidate changes back into master  ([ipfs/go-ipfs#3248](https://github.com/glvd/starship/pull/3248))
	- Add security@ipfs.io GPG key to assets  ([ipfs/go-ipfs#2997](https://github.com/glvd/starship/pull/2997))
	- Improve makefiles  ([ipfs/go-ipfs#2999](https://github.com/glvd/starship/pull/2999))  ([ipfs/go-ipfs#3265](https://github.com/glvd/starship/pull/3265))
	- Refactor install.sh script  ([ipfs/go-ipfs#3194](https://github.com/glvd/starship/pull/3194))
	- Add test check for go code formatting  ([ipfs/go-ipfs#3421](https://github.com/glvd/starship/pull/3421))
	- bin: dist_get script: prevents get_go_vars() returns same values twice  ([ipfs/go-ipfs#3079](https://github.com/glvd/starship/pull/3079))

- Dependencies
	- Update libp2p to have fixed spdystream dep  ([ipfs/go-ipfs#3210](https://github.com/glvd/starship/pull/3210))
	- Update libp2p and dht packages  ([ipfs/go-ipfs#3263](https://github.com/glvd/starship/pull/3263))
	- Update to libp2p 4.0.1 and propogate other changes  ([ipfs/go-ipfs#3284](https://github.com/glvd/starship/pull/3284))
	- Update to libp2p 4.0.4  ([ipfs/go-ipfs#3361](https://github.com/glvd/starship/pull/3361))
	- Update go-libp2p across codebase  ([ipfs/go-ipfs#3406](https://github.com/glvd/starship/pull/3406))
	- Update to go-libp2p 4.1.0  ([ipfs/go-ipfs#3373](https://github.com/glvd/starship/pull/3373))
	- Update deps for libp2p 3.4.0  ([ipfs/go-ipfs#3110](https://github.com/glvd/starship/pull/3110))
	- Update go-libp2p-swarm with deadlock fixes  ([ipfs/go-ipfs#3339](https://github.com/glvd/starship/pull/3339))
	- Update to new cid and ipld node packages  ([ipfs/go-ipfs#3326](https://github.com/glvd/starship/pull/3326))
	- Update to newer ipld node interface with Copy and better Tree  ([ipfs/go-ipfs#3391](https://github.com/glvd/starship/pull/3391))
	- Update experimental go-multiplex to 0.2.6  ([ipfs/go-ipfs#3475](https://github.com/glvd/starship/pull/3475))
	- Rework routing interfaces to make separation easier  ([ipfs/go-ipfs#3107](https://github.com/glvd/starship/pull/3107))
	- Update to dht code with fixed GetClosestPeers  ([ipfs/go-ipfs#3346](https://github.com/glvd/starship/pull/3346))
	- Move go-is-domain to gx  ([ipfs/go-ipfs#3077](https://github.com/glvd/starship/pull/3077))
	- Extract thirdparty/loggables and thirdparty/peerset  ([ipfs/go-ipfs#3204](https://github.com/glvd/starship/pull/3204))
	- Completely remove go-key dep  ([ipfs/go-ipfs#3439](https://github.com/glvd/starship/pull/3439))
	- Remove randbo dep, its no longer needed  ([ipfs/go-ipfs#3118](https://github.com/glvd/starship/pull/3118))
	- Update libp2p for identify configuration updates  ([ipfs/go-ipfs#3539](https://github.com/glvd/starship/pull/3539))
	- Use newer flatfs sharding scheme  ([ipfs/go-ipfs#3608](https://github.com/glvd/starship/pull/3608))

- Testing
	- fix test_fsh arg quoting in ipfs-test-lib  ([ipfs/go-ipfs#3085](https://github.com/glvd/starship/pull/3085))
	- 100% coverage for blocks/blocksutil  ([ipfs/go-ipfs#3090](https://github.com/glvd/starship/pull/3090))
	- 100% coverage on blocks/set  ([ipfs/go-ipfs#3084](https://github.com/glvd/starship/pull/3084))
	- 81% coverage on blockstore  ([ipfs/go-ipfs#3074](https://github.com/glvd/starship/pull/3074))
	- 80% coverage of unixfs/mod  ([ipfs/go-ipfs#3096](https://github.com/glvd/starship/pull/3096))
	- 82% coverage on blocks  ([ipfs/go-ipfs#3086](https://github.com/glvd/starship/pull/3086))
	- 87% coverage on unixfs   ([ipfs/go-ipfs#3492](https://github.com/glvd/starship/pull/3492)) 
	- Improve coverage on routing/offline  ([ipfs/go-ipfs#3516](https://github.com/glvd/starship/pull/3516))
	- Add test for flags package   ([ipfs/go-ipfs#3449](https://github.com/glvd/starship/pull/3449))
	- improve test coverage on merkledag package  ([ipfs/go-ipfs#3113](https://github.com/glvd/starship/pull/3113))
	- 80% coverage of unixfs/io ([ipfs/go-ipfs#3097](https://github.com/glvd/starship/pull/3097))
	- Accept more than one digit in repo version tests  ([ipfs/go-ipfs#3130](https://github.com/glvd/starship/pull/3130))
	- Fix typo in hash in t0050  ([ipfs/go-ipfs#3170](https://github.com/glvd/starship/pull/3170))
	- fix bug in pinsets and add a stress test for the scenario  ([ipfs/go-ipfs#3273](https://github.com/glvd/starship/pull/3273))  ([ipfs/go-ipfs#3302](https://github.com/glvd/starship/pull/3302))
	- Report coverage to codecov  ([ipfs/go-ipfs#3473](https://github.com/glvd/starship/pull/3473))
	- Add test for 'ipfs config replace'  ([ipfs/go-ipfs#3073](https://github.com/glvd/starship/pull/3073))
	- Fix netcat on macOS not closing socket when the stdin sends EOF  ([ipfs/go-ipfs#3515](https://github.com/glvd/starship/pull/3515))

- Documentation
	- Update dns help with a correct domain name  ([ipfs/go-ipfs#3087](https://github.com/glvd/starship/pull/3087))
	- Add period to `ipfs pin rm`  ([ipfs/go-ipfs#3088](https://github.com/glvd/starship/pull/3088))
	- Make all Taglines use imperative mood  ([ipfs/go-ipfs#3041](https://github.com/glvd/starship/pull/3041))
	- Document listing commands better  ([ipfs/go-ipfs#3083](https://github.com/glvd/starship/pull/3083))
	- Add notes to readme on building for uncommon systems  ([ipfs/go-ipfs#3051](https://github.com/glvd/starship/pull/3051))
	- Add branch naming conventions doc  ([ipfs/go-ipfs#3035](https://github.com/glvd/starship/pull/3035))
	- Replace <default> keyword with <<default>>  ([ipfs/go-ipfs#3129](https://github.com/glvd/starship/pull/3129))
	- Fix Add() docs regarding pinning  ([ipfs/go-ipfs#3513](https://github.com/glvd/starship/pull/3513))
	- Add sudo to install commands.  ([ipfs/go-ipfs#3201](https://github.com/glvd/starship/pull/3201))
	- Add docs for `"commands".Command.Run`  ([ipfs/go-ipfs#3382](https://github.com/glvd/starship/pull/3382))
	- Put config keys in proper case  ([ipfs/go-ipfs#3365](https://github.com/glvd/starship/pull/3365))
	- Fix link in `ipfs stats bw` help message  ([ipfs/go-ipfs#3620](https://github.com/glvd/starship/pull/3620))
...
- Fix bug in pinsets fanout, and add stress test. (@whyrusleeping, [ipfs/go-ipfs#3273](https://github.com/glvd/starship/pull/3273))
...
- Require Go 1.7. (@whyrusleeping, @Kubuxu, @lgierth, [ipfs/go-ipfs#3163](https://github.com/glvd/starship/pull/3163))
  - For this purpose, switch Docker image from Alpine 3.4 to Alpine Edge.
- Fix cancellation of Bitswap `wantlist` entries. (@whyrusleeping, [ipfs/go-ipfs#3182](https://github.com/glvd/starship/pull/3182))
- Fix clearing of `active` state of Bitswap provider queries. (@whyrusleeping, [ipfs/go-ipfs#3169](https://github.com/glvd/starship/pull/3169))
- Fix a panic in the DHT code. (@Kubuxu, [ipfs/go-ipfs#3200](https://github.com/glvd/starship/pull/3200))
- Improve handling of `Identity` field in `ipfs config` command. (@Kubuxu, @whyrusleeping, [ipfs/go-ipfs#3141](https://github.com/glvd/starship/pull/3141))
- Fix explicit adding of symlinked files and directories. (@kevina, [ipfs/go-ipfs#3135](https://github.com/glvd/starship/pull/3135))
- Fix bash auto-completion of `ipfs daemon --unrestricted-api` option. (@lgierth, [ipfs/go-ipfs#3159](https://github.com/glvd/starship/pull/3159))
- Introduce a new timeout tool for tests to avoid licensing issues. (@Kubuxu, [ipfs/go-ipfs#3152](https://github.com/glvd/starship/pull/3152))
- Improve output for migrations of fs-repo. (@lgierth, [ipfs/go-ipfs#3158](https://github.com/glvd/starship/pull/3158))
- Fix info notice of commands taking input from stdin. (@Kubuxu, [ipfs/go-ipfs#3134](https://github.com/glvd/starship/pull/3134))
- Bring back a few tests for stdin handling of `ipfs cat` and `ipfs add`. (@Kubuxu, [ipfs/go-ipfs#3144](https://github.com/glvd/starship/pull/3144))
- Improve sharness tests for `ipfs repo verify` command. (@whyrusleeping, [ipfs/go-ipfs#3148](https://github.com/glvd/starship/pull/3148))
- Improve sharness tests for CORS headers on the gateway. (@Kubuxu, [ipfs/go-ipfs#3142](https://github.com/glvd/starship/pull/3142))
- Improve tests for pinning within `ipfs files`. (@kevina, [ipfs/go-ipfs#3151](https://github.com/glvd/starship/pull/3151))
- Improve tests for the automatic raising of file descriptor limits. (@whyrusleeping, [ipfs/go-ipfs#3149](https://github.com/glvd/starship/pull/3149))

### 0.4.3-rc3 - 2016-08-11

This release candidate fixes a panic that occurs when input from stdin was
expected, but none was given: [ipfs/go-ipfs#3050](https://github.com/glvd/starship/pull/3050)
...
- Regressions
  ...
  (@whyrusleeping, [ipfs/go-ipfs#2989](https://github.com/glvd/starship/pull/2989))
  - Fix `ipfs refs --edges` not printing edges.
  (@Kubuxu, [ipfs/go-ipfs#3007](https://github.com/glvd/starship/pull/3007))
  - Fix progress option for `ipfs add` defaulting to true on the HTTP API.
  (@whyrusleeping, [ipfs/go-ipfs#3025](https://github.com/glvd/starship/pull/3025))
  - Fix erroneous printing of stdin reading message.
  (@whyrusleeping, [ipfs/go-ipfs#3033](https://github.com/glvd/starship/pull/3033))
  - Fix panic caused by passing `--mount` and `--offline` flags to `ipfs daemon`.
  (@Kubuxu, [ipfs/go-ipfs#3022](https://github.com/glvd/starship/pull/3022))
  - Fix symlink path resolution on windows.
  (@Kubuxu, [ipfs/go-ipfs#3023](https://github.com/glvd/starship/pull/3023))
  - Add in code to prevent issue 3032 from crashing the daemon.
  (@whyrusleeping, [ipfs/go-ipfs#3037](https://github.com/glvd/starship/pull/3037))
...
- Security Vulnerability
  ...
  - The `master` branch if go-ipfs suffered from a vulnerability for about 3 weeks. It allowed an attacker to use an iframe to request malicious HTML and JS from the API of a local go-ipfs node. The attacker could then gain unrestricted access to the node's API, and e.g. extract the private key. We fixed this issue by reintroducing restrictions on which particular objects can be loaded through the API (@lgierth, [ipfs/go-ipfs#2949](https://github.com/glvd/starship/pull/2949)), and by completely excluding the private key from the API (@Kubuxu, [ipfs/go-ipfs#2957](https://github.com/glvd/starship/pull/2957)). We will also work on more hardening of the API in the next release.
  - **The previous release 0.4.2 is not vulnerable. That means if you're using official binaries from [dist.ipfs.io](https://dist.ipfs.io) you're not affected.** If you're running go-ipfs built from the `master` branch between June 17th ([ipfs/go-ipfs@1afebc21](https://github.com/glvd/starship/commit/1afebc21f324982141ca8a29710da0d6f83ca804)) and July 7th ([ipfs/go-ipfs@39bef0d5](https://github.com/glvd/starship/commit/39bef0d5b01f70abf679fca2c4d078a2d55620e2)), please update to v0.4.3-rc1 immediately.
...
- Notable changes
  ...
  - Improve Bitswap performance. (@whyrusleeping, [ipfs/go-ipfs#2727](https://github.com/glvd/starship/pull/2727), [ipfs/go-ipfs#2798](https://github.com/glvd/starship/pull/2798))
  - Improve Content Routing and Peer Routing performance. (@whyrusleeping, [ipfs/go-ipfs#2817](https://github.com/glvd/starship/pull/2817), [ipfs/go-ipfs#2841](https://github.com/glvd/starship/pull/2841))
  - Improve datastore, blockstore, and dagstore performance. (@kevina, @Kubuxu, @whyrusleeping [ipfs/go-datastore#43](https://github.com/ipfs/go-datastore/pull/43), [ipfs/go-ipfs#2885](https://github.com/glvd/starship/pull/2885), [ipfs/go-ipfs#2961](https://github.com/glvd/starship/pull/2961), [ipfs/go-ipfs#2953](https://github.com/glvd/starship/pull/2953), [ipfs/go-ipfs#2960](https://github.com/glvd/starship/pull/2960))
  - Content Providers are now stored on disk to gain savings on process memory. (@whyrusleeping, [ipfs/go-ipfs#2804](https://github.com/glvd/starship/pull/2804), [ipfs/go-ipfs#2860](https://github.com/glvd/starship/pull/2860))
  - Migrations of the fs-repo (usually stored at `~/.ipfs`) now run automatically. If there's a TTY available, you'll get prompted when running `ipfs daemon`, and in addition you can use the `--migrate=true` or `--migrate=false` options to avoid the prompt. (@whyrusleeping, @lgierth, [ipfs/go-ipfs#2939](https://github.com/glvd/starship/pull/2939))
  - The internal naming of blocks in the blockstore has changed, which requires a migration of the fs-repo, from version 3 to 4. (@whyrusleeping, [ipfs/go-ipfs#2903](https://github.com/glvd/starship/pull/2903))
  - We now automatically raise the file descriptor limit to 1024 if neccessary. (@whyrusleeping, [ipfs/go-ipfs#2884](https://github.com/glvd/starship/pull/2884), [ipfs/go-ipfs#2891](https://github.com/glvd/starship/pull/2891))
  - After a long struggle with deadlocks and hanging connections, we've decided to disable the uTP transport by default for now. (@whyrusleeping, [ipfs/go-ipfs#2840](https://github.com/glvd/starship/pull/2840), [ipfs/go-libp2p-transport@88244000](https://github.com/ipfs/go-libp2p-transport/commit/88244000f0ce8851ffcfbac746ebc0794b71d2a4))
  - There is now documentation for the configuration options in `docs/config.md`. (@whyrusleeping, [ipfs/go-ipfs#2974](https://github.com/glvd/starship/pull/2974))
  - All commands now sanely handle the combination of stdin and optional flags in certain edge cases. (@lgierth, [ipfs/go-ipfs#2952](https://github.com/glvd/starship/pull/2952))

- New Features

  - Add `--offline` option to `ipfs daemon` command, which disables all swarm networking. (@Kubuxu, [ipfs/go-ipfs#2696](https://github.com/glvd/starship/pull/2696), [ipfs/go-ipfs#2867](https://github.com/glvd/starship/pull/2867))
  - Add `Datastore.HashOnRead` option for verifying block hashes on read access. (@Kubuxu, [ipfs/go-ipfs#2904](https://github.com/glvd/starship/pull/2904))
  - Add `Datastore.BloomFilterSize` option for tuning the blockstore's new lookup bloom filter. (@Kubuxu, [ipfs/go-ipfs#2973](https://github.com/glvd/starship/pull/2973))

- Bugfixes

  - Fix publishing of local IPNS entries, and more. (@whyrusleeping, [ipfs/go-ipfs#2943](https://github.com/glvd/starship/pull/2943))
  - Fix progress bars in `ipfs add` and `ipfs get`. (@whyrusleeping, [ipfs/go-ipfs#2893](https://github.com/glvd/starship/pull/2893), [ipfs/go-ipfs#2948](https://github.com/glvd/starship/pull/2948))
  - Make sure files added through `ipfs files` are pinned and don't get GC'd. (@kevina, [ipfs/go-ipfs#2872](https://github.com/glvd/starship/pull/2872))
  - Fix copying into directory using `ipfs files cp`. (@whyrusleeping, [ipfs/go-ipfs#2977](https://github.com/glvd/starship/pull/2977))
  - Fix `ipfs version --commit` with Docker containers. (@lgierth, [ipfs/go-ipfs#2734](https://github.com/glvd/starship/pull/2734))
  - Run `ipfs diag` commands in the daemon instead of the CLI. (@Kubuxu, [ipfs/go-ipfs#2761](https://github.com/glvd/starship/pull/2761))
  - Fix protobuf encoding on the API and in commands. (@stebalien, [ipfs/go-ipfs#2516](https://github.com/glvd/starship/pull/2516))
  - Fix goroutine leak in `/ipfs/ping` protocol handler. (@whyrusleeping, [ipfs/go-libp2p#58](https://github.com/ipfs/go-libp2p/pull/58))
  - Fix `--flags` option on `ipfs commands`. (@Kubuxu, [ipfs/go-ipfs#2773](https://github.com/glvd/starship/pull/2773))
  - Fix the error channels in `namesys`. (@whyrusleeping, [ipfs/go-ipfs#2788](https://github.com/glvd/starship/pull/2788))
  - Fix consumptions of observed swarm addresses. (@whyrusleeping, [ipfs/go-libp2p#63](https://github.com/ipfs/go-libp2p/pull/63), [ipfs/go-ipfs#2771](https://github.com/glvd/starship/issues/2771))
  - Fix a rare DHT panic. (@whyrusleeping, [ipfs/go-ipfs#2856](https://github.com/glvd/starship/pull/2856))
  ...
  - Prevent DHT connection hangs. (@whyrusleeping, [ipfs/go-ipfs#2826](https://github.com/glvd/starship/pull/2826), [ipfs/go-ipfs#2863](https://github.com/glvd/starship/pull/2863))
  - Fix NDJSON output of `ipfs refs local`. (@Kubuxu, [ipfs/go-ipfs#2812](https://github.com/glvd/starship/pull/2812))
  - Fix race condition in NAT detection. (@whyrusleeping, [ipfs/go-libp2p#69](https://github.com/ipfs/go-libp2p/pull/69))
  - Fix error messages. (@whyrusleeping, @Kubuxu, [ipfs/go-ipfs#2905](https://github.com/glvd/starship/pull/2905), [ipfs/go-ipfs#2928](https://github.com/glvd/starship/pull/2928))

- Enhancements

  - Increase maximum object size on `ipfs put` from 1 MiB to 2 MiB. The maximum object size on the wire including all framing is 4 MiB. (@kpcyrd, [ipfs/go-ipfs#2980](https://github.com/glvd/starship/pull/2980))
  - Add CORS headers to the Gateway's default config. (@Kubuxu, [ipfs/go-ipfs#2778](https://github.com/glvd/starship/pull/2778))
  - Clear the dial backoff for a peer when using `ipfs swarm connect`. (@whyrusleeping, [ipfs/go-ipfs#2941](https://github.com/glvd/starship/pull/2941))
  - Allow passing options to daemon in Docker container. (@lgierth, [ipfs/go-ipfs#2955](https://github.com/glvd/starship/pull/2955))
  - Add `-v/--verbose` to `ìpfs swarm peers` command. (@csasarak, [ipfs/go-ipfs#2713](https://github.com/glvd/starship/pull/2713))
  - Add `--format`, `--hash`, and `--size` options to `ipfs files stat` command. (@Kubuxu, [ipfs/go-ipfs#2706](https://github.com/glvd/starship/pull/2706))
  - Add `--all` option to `ipfs version` command. (@Kubuxu, [ipfs/go-ipfs#2790](https://github.com/glvd/starship/pull/2790))
  - Add `ipfs repo version` command. (@pfista, [ipfs/go-ipfs#2598](https://github.com/glvd/starship/pull/2598))
  - Add `ipfs repo verify` command. (@whyrusleeping, [ipfs/go-ipfs#2924](https://github.com/glvd/starship/pull/2924), [ipfs/go-ipfs#2951](https://github.com/glvd/starship/pull/2951))
  - Add `ipfs stats repo` and `ipfs stats bitswap` command aliases. (@pfista, [ipfs/go-ipfs#2810](https://github.com/glvd/starship/pull/2810))
  - Add success indication to responses of `ipfs ping` command. (@Kubuxu, [ipfs/go-ipfs#2813](https://github.com/glvd/starship/pull/2813))
  - Save changes made via `ipfs swarm filter` to the config file. (@yuvallanger, [ipfs/go-ipfs#2880](https://github.com/glvd/starship/pull/2880))
  - Expand `ipfs_p2p_peers` metric to include libp2p transport. (@lgierth, [ipfs/go-ipfs#2728](https://github.com/glvd/starship/pull/2728))
  - Rework `ipfs files add` internals to avoid caching and prevent memory leaks. (@whyrusleeping, [ipfs/go-ipfs#2795](https://github.com/glvd/starship/pull/2795))
  - Support `GOPATH` with multiple path components. (@karalabe, @lgierth, @djdv, [ipfs/go-ipfs#2808](https://github.com/glvd/starship/pull/2808), [ipfs/go-ipfs#2862](https://github.com/glvd/starship/pull/2862), [ipfs/go-ipfs#2975](https://github.com/glvd/starship/pull/2975))

- General Codebase

  - Take steps towards the `filestore` datastore. (@kevina, [ipfs/go-ipfs#2792](https://github.com/glvd/starship/pull/2792), [ipfs/go-ipfs#2634](https://github.com/glvd/starship/pull/2634))
  - Update recommended Golang version to 1.6.2 (@Kubuxu, [ipfs/go-ipfs#2724](https://github.com/glvd/starship/pull/2724))
  - Update to Gx 0.8.0 and Gx-Go 1.2.1, which is faster and less noisy. (@whyrusleeping, [ipfs/go-ipfs#2979](https://github.com/glvd/starship/pull/2979))
  - Use `go4.org/lock` instead of `camlistore/lock` for locking. (@whyrusleeping, [ipfs/go-ipfs#2887](https://github.com/glvd/starship/pull/2887))
  - Manage `go.uuid`, `hamming`, `backoff`, `proquint`, `pb`, `go-context`, `cors`, `go-datastore` packages with Gx. (@Kubuxu, [ipfs/go-ipfs#2733](https://github.com/glvd/starship/pull/2733), [ipfs/go-ipfs#2736](https://github.com/glvd/starship/pull/2736), [ipfs/go-ipfs#2757](https://github.com/glvd/starship/pull/2757), [ipfs/go-ipfs#2825](https://github.com/glvd/starship/pull/2825), [ipfs/go-ipfs#2838](https://github.com/glvd/starship/pull/2838))
  - Clean up the gateway's surface. (@lgierth, [ipfs/go-ipfs#2874](https://github.com/glvd/starship/pull/2874))
  - Simplify the API gateway's access restrictions. (@lgierth, [ipfs/go-ipfs#2949](https://github.com/glvd/starship/pull/2949), [ipfs/go-ipfs#2956](https://github.com/glvd/starship/pull/2956))
  - Update docker image to Alpine Linux 3.4 and remove Go version constraint. (@lgierth, [ipfs/go-ipfs#2901](https://github.com/glvd/starship/pull/2901), [ipfs/go-ipfs#2929](https://github.com/glvd/starship/pull/2929))
  - Clarify `Dockerfile` and `Dockerfile.fast`. (@lgierth, [ipfs/go-ipfs#2796](https://github.com/glvd/starship/pull/2796))
  - Simplify resolution of Git commit refs in Dockerfiles. (@lgierth, [ipfs/go-ipfs#2754](https://github.com/glvd/starship/pull/2754))
  - Consolidate `--verbose` description across commands. (@Kubuxu, [ipfs/go-ipfs#2746](https://github.com/glvd/starship/pull/2746))
  - Allow setting position of default values in command option descriptions. (@Kubuxu, [ipfs/go-ipfs#2744](https://github.com/glvd/starship/pull/2744))
  - Set explicit default values for boolean command options. (@RichardLitt, [ipfs/go-ipfs#2657](https://github.com/glvd/starship/pull/2657))
  - Autogenerate command synopsises. (@Kubuxu, [ipfs/go-ipfs#2785](https://github.com/glvd/starship/pull/2785))
  - Fix and improve lots of documentation. (@RichardLitt, [ipfs/go-ipfs#2741](https://github.com/glvd/starship/pull/2741), [ipfs/go-ipfs#2781](https://github.com/glvd/starship/pull/2781))
  - Improve command descriptions to fit a width of 78 characters. (@RichardLitt, [ipfs/go-ipfs#2779](https://github.com/glvd/starship/pull/2779), [ipfs/go-ipfs#2780](https://github.com/glvd/starship/pull/2780), [ipfs/go-ipfs#2782](https://github.com/glvd/starship/pull/2782))
  - Fix filename conflict in the debugging guide. (@Kubuxu, [ipfs/go-ipfs#2752](https://github.com/glvd/starship/pull/2752))
  - Decapitalize log messages, according to Golang style guides. (@RichardLitt, [ipfs/go-ipfs#2853](https://github.com/glvd/starship/pull/2853))
  - Add Github Issues HowTo guide. (@RichardLitt, @chriscool, [ipfs/go-ipfs#2889](https://github.com/glvd/starship/pull/2889), [ipfs/go-ipfs#2895](https://github.com/glvd/starship/pull/2895))
  - Add Github Issue template. (@chriscool, [ipfs/go-ipfs#2786](https://github.com/glvd/starship/pull/2786))
  - Apply standard-readme to the README file. (@RichardLitt, [ipfs/go-ipfs#2883](https://github.com/glvd/starship/pull/2883))
  - Fix issues pointed out by `govet`. (@Kubuxu, [ipfs/go-ipfs#2854](https://github.com/glvd/starship/pull/2854))
  - Clarify `ipfs get` error message. (@whyrusleeping, [ipfs/go-ipfs#2886](https://github.com/glvd/starship/pull/2886))
  - Remove dead code. (@whyrusleeping, [ipfs/go-ipfs#2819](https://github.com/glvd/starship/pull/2819))
  - Add changelog for v0.4.3. (@lgierth, [ipfs/go-ipfs#2984](https://github.com/glvd/starship/pull/2984))

- Tests & CI

  - Fix flaky `ipfs mount` sharness test by using the `iptb` tool. (@noffle, [ipfs/go-ipfs#2707](https://github.com/glvd/starship/pull/2707))
  - Fix flaky IP port selection in tests. (@Kubuxu, [ipfs/go-ipfs#2855](https://github.com/glvd/starship/pull/2855))
  - Fix CLI tests on OSX by resolving /tmp symlink. (@Kubuxu, [ipfs/go-ipfs#2926](https://github.com/glvd/starship/pull/2926))
  - Fix flaky GC test by running the daemon in offline mode. (@Kubuxu, [ipfs/go-ipfs#2908](https://github.com/glvd/starship/pull/2908))
  - Add tests for `ipfs add` with hidden files. (@Kubuxu, [ipfs/go-ipfs#2756](https://github.com/glvd/starship/pull/2756))
  - Add test to make sure the body of HEAD responses is empty. (@Kubuxu, [ipfs/go-ipfs#2775](https://github.com/glvd/starship/pull/2775))
  - Add test to catch misdials. (@Kubuxu, [ipfs/go-ipfs#2831](https://github.com/glvd/starship/pull/2831))
  - Mark flaky tests for `ipfs dht query` as known failure. (@noffle, [ipfs/go-ipfs#2720](https://github.com/glvd/starship/pull/2720))
  - Remove failing blockstore-without-context test. (@Kubuxu, [ipfs/go-ipfs#2857](https://github.com/glvd/starship/pull/2857))
  - Fix `--version` tests for versions with a suffix like `-dev` or `-rc1`. (@lgierth, [ipfs/go-ipfs#2937](https://github.com/glvd/starship/pull/2937))
  - Make sharness tests work in cases where go-ipfs is symlinked into GOPATH. (@lgierth, [ipfs/go-ipfs#2937](https://github.com/glvd/starship/pull/2937))
  - Add variable delays to blockstore mocks. (@rikonor, [ipfs/go-ipfs#2871](https://github.com/glvd/starship/pull/2871))
  - Disable Travis CI email notifications. (@Kubuxu, [ipfs/go-ipfs#2896](https://github.com/glvd/starship/pull/2896))
