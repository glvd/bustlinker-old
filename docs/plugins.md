...
[plugin](https://godoc.org/github.com/glvd/bustlinker/plugin) package.
...
|---------------------------------------------------------------------------------|-----------|-----------|------------------------------------------------|
| [git](https://github.com/glvd/bustlinker/tree/master/plugin/plugins/git)           | IPLD      | x         | An IPLD format for git objects.                |
| [badgerds](https://github.com/glvd/bustlinker/tree/master/plugin/plugins/badgerds) | Datastore | x         | A high performance but experimental datastore. |
| [flatfs](https://github.com/glvd/bustlinker/tree/master/plugin/plugins/flatfs)     | Datastore | x         | A stable filesystem-based datastore.           |
| [levelds](https://github.com/glvd/bustlinker/tree/master/plugin/plugins/levelds)   | Datastore | x         | A stable, flexible datastore backend.          |
...
[plugin/plugins](https://github.com/glvd/bustlinker/tree/master/plugin/plugins),
run:
