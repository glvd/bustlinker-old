...
- cut a pre-release on [github](https://github.com/glvd/starship/releases) and upload the result of the ipfs/distributions build in the previous step.
- Announce the RC:
  - [ ] On IRC/Matrix (both #ipfs and #ipfs-dev)
  - [ ] To the _early testers_ listed in [docs/EARLY_TESTERS.md](https://github.com/glvd/starship/tree/master/docs/EARLY_TESTERS.md).

Checklist:

- [ ] **Stage 0 - Automated Testing**
  - [ ] Feature freeze. If any "non-trivial" changes (see the footnotes of [docs/releases.md](https://github.com/glvd/starship/tree/master/docs/releases.md) for a definition) get added to the release, uncheck all the checkboxes and return to this stage.
...
- [ ] **Stage 1 - Internal Testing**
  - [ ] CHANGELOG.md has been updated
    - use [`./bin/mkreleaselog`](https://github.com/glvd/starship/tree/master/bin/mkreleaselog) to generate a nice starter list
  - [ ] Network Testing:
    - [ ] test lab things - TBD
...
- [ ] **Stage 2 - Community Dev Testing**
  - [ ] Reach out to the IPFS _early testers_ listed in [docs/EARLY_TESTERS.md](https://github.com/glvd/starship/tree/master/docs/EARLY_TESTERS.md) for testing this release (check when no more problems have been reported). If you'd like to be added to this list, please file a PR.
...
- [ ] **Stage 3 - Community Prod Testing**
  - [ ] Documentation
    - [ ] Ensure that [CHANGELOG.md](https://github.com/glvd/starship/tree/master/CHANGELOG.md) is up to date
    - [ ] Ensure that [README.md](https://github.com/glvd/starship/tree/master/README.md)  is up to date
  ...
  - [ ] Invite the IPFS [_early testers_](https://github.com/glvd/starship/tree/master/docs/EARLY_TESTERS.md) to deploy the release to part of their production infrastructure.
...
- [ ] **Stage 4 - Release**
  - [ ] Final preparation
    - [ ] Verify that version string in [`version.go`](https://github.com/glvd/starship/tree/master/version.go) has been updated
    ...
    - [ ] Release published
      ...
      - [ ] to [github](https://github.com/glvd/starship/releases)
...
- Check the issues with the `help wanted` label in the [go-ipfs repo](https://github.com/glvd/starship/issues?q=is%3Aopen+is%3Aissue+label%3A%22help+wanted%22)
