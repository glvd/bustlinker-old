...
.PHONY: github.com/glvd/bustlinker/test/dependencies/pollEndpoint
$(d)/pollEndpoint: github.com/glvd/bustlinker/test/dependencies/pollEndpoint
	$(go-build-testdep)
TGTS_$(d) += $(d)/pollEndpoint

.PHONY: github.com/glvd/bustlinker/test/dependencies/go-sleep
$(d)/go-sleep: github.com/glvd/bustlinker/test/dependencies/go-sleep
	$(go-build-testdep)
TGTS_$(d) += $(d)/go-sleep

.PHONY: github.com/glvd/bustlinker/test/dependencies/graphsync-get
$(d)/graphsync-get: github.com/glvd/bustlinker/test/dependencies/graphsync-get
	$(go-build-testdep)
TGTS_$(d) += $(d)/graphsync-get

.PHONY: github.com/glvd/bustlinker/test/dependencies/go-timeout
$(d)/go-timeout: github.com/glvd/bustlinker/test/dependencies/go-timeout
	$(go-build-testdep)
TGTS_$(d) += $(d)/go-timeout

.PHONY: github.com/glvd/bustlinker/test/dependencies/iptb
$(d)/iptb: github.com/glvd/bustlinker/test/dependencies/iptb
	$(go-build-testdep)
TGTS_$(d) += $(d)/iptb

.PHONY: github.com/glvd/bustlinker/test/dependencies/ma-pipe-unidir
$(d)/ma-pipe-unidir: github.com/glvd/bustlinker/test/dependencies/ma-pipe-unidir
	$(go-build-testdep)
TGTS_$(d) += $(d)/ma-pipe-unidir

.PHONY: github.com/glvd/bustlinker/test/dependencies/json-to-junit
$(d)/json-to-junit: github.com/glvd/bustlinker/test/dependencies/json-to-junit
	$(go-build-testdep)
