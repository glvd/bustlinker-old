...
`,
	...
	Options: []cmds.Option{
		...
		// cmds.StringOption(apiAddrKwd, "PeerCache for the daemon rpc API (overrides config)"),
		// cmds.StringOption(swarmAddrKwd, "PeerCache for the swarm socket (overrides config)"),
	},
